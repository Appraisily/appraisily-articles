---
title: 'Civil War Button Identification: Expert Guide to Union and Confederate Relics'
description: >-
...
slug: civil-war-old-buttons-identification
...
image_alt: >-
  Authentic Civil War military uniform buttons showing Union eagle designs and
  Confederate state emblems from 1861-1865
category: Militaria
type: article
author: Appraisily Team
featured: true
meta_title: 'Civil War Button Identification Guide: Union & Confederate Relics'
meta_description: >-
  Discover how to identify authentic Civil War buttons with our expert guide
  covering Union and Confederate designs, materials, markings, values, and
  preservation tips.
canonical_url: 'https://articles.appraisily.com/articles/civil-war-old-buttons-identification'
keywords:
...
structured_data:
  ...
  '@type': Article
  headline: >-
    Civil War Button Identification: Expert Guide to Union and Confederate
    Relics
  description: >-
    Learn how to identify authentic Civil War buttons with this comprehensive
    guide covering Union and Confederate designs, materials, values, and
...
Civil War buttons are among the most collectible and historically significant military artifacts from America's defining conflict. These small metal relics served both functional and symbolic purposes on military uniforms from 1861-1865, representing regiment, branch, rank, and allegiance. For collectors, metal detectorists, and history enthusiasts, understanding how to properly identify these buttons is essential for determining authenticity, historical context, and value.
{{< /content-modules/section-header >}}

![Various Civil War buttons including Union eagle designs and Confederate state buttons](https://ik.imagekit.io/appraisily/SEO/civil-war-old-buttons-identification/civil-war-old-buttons-identification-image-1_RfpBrrxHT.png)
...
{{< content-modules/section-header title="Materials and Manufacturing" level="2" >}}
Understanding the materials and manufacturing techniques used for Civil War buttons is the first step in proper identification. These characteristics can help distinguish authentic period buttons from later reproductions.
{{< /content-modules/section-header >}}
...
![Close-up of Civil War button showing brass construction and backmark](https://ik.imagekit.io/appraisily/SEO/civil-war-old-buttons-identification/civil-war-old-buttons-identification-image-2_vxqrJEM9p.png)
...
{{< content-modules/section-header title="Union Button Identification" level="2" >}}
Union buttons are more common than their Confederate counterparts and feature distinctive designs that make them relatively straightforward to identify.
{{< /content-modules/section-header >}}
...
![Union eagle button with shield design and "E Pluribus Unum" ribbon](https://ik.imagekit.io/appraisily/SEO/civil-war-old-buttons-identification/civil-war-old-buttons-identification-image-3_bXQKRkW_lC.png)
...
{{< content-modules/section-header title="Confederate Button Identification" level="2" >}}
Confederate buttons are generally rarer and more valuable than Union examples due to lower production numbers and the South's limited manufacturing capabilities during the war.
{{< /content-modules/section-header >}}
...
![Confederate cavalry C button with chocolate brown patina](https://ik.imagekit.io/appraisily/SEO/civil-war-old-buttons-identification/civil-war-old-buttons-identification-image-4_8kQ4EvhnbY.png)
...
{{< content-modules/section-header title="Dating and Authenticating Civil War Buttons" level="2" >}}
Properly dating and authenticating Civil War buttons requires careful examination of multiple characteristics.
{{< /content-modules/section-header >}}
...
{{< visual-modules/hero-image src="https://ik.imagekit.io/appraisily/SEO/civil-war-old-buttons-identification/civil-war-old-buttons-identification-image-5_jseXMkLIV.png" alt="Collection of authentic Union and Confederate Civil War buttons with patina" caption="Authentic Civil War buttons showing various designs and natural patina from over 150 years of aging" />}}

{{< content-modules/section-header title="Common Reproduction Warning Signs" level="2" >}}
The market is unfortunately filled with modern reproductions. Here's how to spot them:
{{< /content-modules/section-header >}}
...
{{< data-modules/price-table title="Civil War Button Value Ranges" description="Current market values based on 2023 auction and dealer prices" >}}
<tr>
  <td>Common Union Eagle Buttons</td>
  <td>$35-$150</td>
  <td>Condition dependent; higher with clear backmarks</td>
</tr>
<tr>
  <td>Union State Buttons</td>
  <td>$75-$300</td>
  <td>Rarity varies by state; NY most common</td>
</tr>
<tr>
  <td>Confederate "CSA" Buttons</td>
  <td>$300-$1,200</td>
  <td>Significantly higher for rare variants</td>
</tr>
<tr>
  <td>Confederate State Buttons</td>
  <td>$250-$2,500+</td>
  <td>SC, GA, and NC buttons particularly valuable</td>
</tr>
<tr>
  <td>Confederate Naval Buttons</td>
  <td>$500-$3,000+</td>
  <td>Among the rarest Confederate buttons</td>
</tr>
{{< /data-modules/price-table >}}

{{< visual-modules/timeline title="Evolution of American Military Buttons" >}}
{{< visual-modules/timeline-item date="1775-1783" title="Revolutionary War Era" >}}
...
{{< visual-modules/timeline-item date="1784-1860" title="Early Republic and Antebellum" >}}
...
{{< visual-modules/timeline-item date="1861-1865" title="Civil War Period" >}}
...
{{< visual-modules/timeline-item date="1866-1900" title="Post-Civil War" >}}
...
Proper preservation is essential to maintain both the condition and value of Civil War buttons.
{{< /content-modules/section-header >}}
...
{{< auction-results title="Notable Civil War Button Auction Sales" description="Recent auction highlights from major sales" >}}
<tr>
  <td>Confederate South Carolina Palmetto Button</td>
  <td>$3,250</td>
  <td>February 2023</td>
  <td>Heritage Auctions</td>
</tr>
<tr>
  <td>New York 7th Regiment "National Guard" Button</td>
  <td>$785</td>
  <td>November 2022</td>
  <td>Cowan's Auctions</td>
</tr>
<tr>
  <td>Confederate Naval Officer's Button by Courtney & Tennent</td>
  <td>$4,500</td>
  <td>April 2023</td>
  <td>James D. Julia</td>
</tr>
<tr>
  <td>Union Cavalry Officer's Gilt Button Set (6)</td>
  <td>$1,250</td>
  <td>January 2023</td>
  <td>eBay</td>
</tr>
<tr>
  <td>Confederate Artillery "A" Button</td>
  <td>$950</td>
  <td>March 2023</td>
...
{{< content-modules/section-header title="Metal Detecting for Civil War Buttons" level="2" >}}
Many Civil War buttons are still being discovered today through responsible metal detecting at historical sites.
{{< /content-modules/section-header >}}
...
{{< interactive-modules/resource-links title="External Resources for Civil War Button Collectors" columns="2" >}}
{{< interactive-modules/resource-card title="Relicman Civil War Button Index" url="http://www.relicman.com/buttons/Button0000-Index.html" type="reference" >}}
...
{{< interactive-modules/resource-card title="Inkspot Antiques: US Uniform Buttons" url="https://inkspotantiques.com/index.php?main_page=page&id=1" type="reference" >}}
Detailed reference guide for identifying US military buttons through various eras.
{{< /interactive-modules/resource-card >}}

{{< interactive-modules/resource-card title="US Militaria Forum - Civil War Button Identification" url="https://www.usmilitariaforum.com/forums/index.php?/topic/225253-button-identification-help/" type="forum" >}}
Active forum with experts who can help identify challenging Civil War buttons.
{{< /interactive-modules/resource-card >}}

{{< interactive-modules/resource-card title="Civil War Buttons Reference Guides" url="https://vintagebuttoncollecting.com/civil-war-buttons-reference-guides/" type="article" >}}
Overview of essential reference books and guides for Civil War button collectors.
{{< /interactive-modules/resource-card >}}

{{< interactive-modules/resource-card title="CivilWarButtons.com" url="https://www.civilwarbuttons.com/category/civil-war-buttons" type="shop" >}}
Online shop with authentic Civil War buttons and educational information about identification.
{{< /interactive-modules/resource-card >}}

{{< interactive-modules/resource-card title="Waterbury Button Company History" url="https://waterburybutton.com/about/" type="article" >}}
Historical information on one of the primary manufacturers of Civil War era buttons.
{{< /interactive-modules/resource-card >}}
{{< /interactive-modules/resource-links >}}

{{< content-modules/section-header title="Recommended Reference Books" level="2" >}}
For serious collectors and enthusiasts, these reference books are invaluable for Civil War button identification.
{{< /content-modules/section-header >}}
...
{{< content-modules/faq title="Common Questions About Civil War Button Identification" id="civil-war-button-faq" >}}
...
{{< content-modules/faq-item question="Did Waterbury make Confederate buttons?" >}}
...
{{< content-modules/faq-item question="How can I tell if a Civil War button is authentic?" >}}
...
{{< content-modules/faq-item question="What's the value of a Civil War button?" >}}
...
{{< content-modules/faq-item question="Where can I find Civil War buttons?" >}}
...
{{< content-modules/faq-item question="How should I clean a Civil War button I found?" >}}
...
{{< content-modules/faq-item question="What are the most common Union Army button designs?" >}}
...
Civil War buttons represent a tangible connection to America's pivotal historical conflict. These small artifacts offer remarkable insights into military organization, supply chains, manufacturing capabilities, and the daily lives of soldiers who fought in the war.
{{< /content-modules/section-header >}}
