---
title: 'Antique Wood Planes Value: A Comprehensive Guide to Collecting and Appraising'
description: >-
  Discover the worth of antique wood planes, from identifying valuable models to
  understanding the factors that influence their price in today's collector's
  market.
slug: antique-wood-planes-value
date: 2023-04-18T14:30:00.000Z
lastmod: 2023-04-18T14:30:00.000Z
draft: false
featured_image: ''
image_alt: >-
...
featured: true
meta_title: 'Antique Wood Planes Value Guide: Identification & Pricing'
meta_description: >-
  Discover what makes antique wood planes valuable, from Stanley models to rare
  craftsman pieces. Learn identification tips, pricing factors, and collecting
  advice.
canonical_url: 'https://articles.appraisily.com/articles/antique-wood-planes-value'
keywords:
  - antique wood planes value
  - vintage wooden hand planes
  - Stanley plane identification
  - woodworking collectibles
  - antique tool appraisal
  - wooden plane makers
  - rare carpenter tools
structured_data:
  '@context': 'https://schema.org'
  '@type': Article
  headline: >-
    Antique Wood Planes Value: A Comprehensive Guide to Collecting and
    Appraising
  description: >-
...
{{< data-modules/price-table title="Value Range by Maker" description="Typical market values for common makers in good condition" >}}
<tr>
  <td>Common unmarked planes</td>
  <td>$30-$100</td>
  <td>Basic usability, minimal collector appeal</td>
</tr>
<tr>
  <td>Ohio Tool Company</td>
  <td>$50-$200</td>
  <td>Depending on type and condition</td>
</tr>
<tr>
  <td>Stanley transitional</td>
  <td>$75-$300</td>
  <td>Higher for rare models in excellent condition</td>
</tr>
<tr>
  <td>Signed 18th/19th century craftsman</td>
  <td>$150-$600+</td>
  <td>Historical significance drives premium prices</td>
</tr>
<tr>
  <td>Rare or unusual specialty planes</td>
  <td>$200-$1,000+</td>
  <td>Patternmaker's planes or unusual designs</td>
</tr>
...
{{< content-modules/section-header title="Factors Affecting Antique Wood Plane Values" level="2" >}}
...
{{< visual-modules/timeline title="Evolution of Wooden Plane Design" >}}
  {{< visual-modules/timeline-item date="Pre-1700s" title="Early Wooden Planes" >}}
  ...
  {{< visual-modules/timeline-item date="1700s-1800s" title="Commercial Production Era" >}}
  ...
  {{< visual-modules/timeline-item date="Mid-1800s" title="Transitional Period" >}}
  ...
  {{< visual-modules/timeline-item date="Late 1800s-1920s" title="Decline of Wooden Planes" >}}
...
{{< content-modules/section-header title="Valuing Specific Types of Wooden Planes" level="2" >}}
...
{{< auction-results title="Recent Notable Wooden Plane Sales" description="Documented auction and dealer sales of significant wooden planes" >}}
<tr>
  <td>Adams Patent Patternmaker's Plane</td>
  <td>$19,550</td>
  <td>2023</td>
  <td>Specialized Auction House</td>
</tr>
<tr>
  <td>18th Century Crown Molder by John Cogdell</td>
  <td>$4,780</td>
  <td>2022</td>
  <td>Martin J. Donnelly Auctions</td>
</tr>
<tr>
  <td>Set of 26 Matched Hollows and Rounds</td>
  <td>$3,200</td>
  <td>2023</td>
  <td>Brown Auction Services</td>
</tr>
<tr>
  <td>Early American Gunstock Plane</td>
  <td>$1,750</td>
  <td>2022</td>
  <td>eBay</td>
</tr>
<tr>
  <td>Norris No. 13 Chariot Plane</td>
  <td>$1,200</td>
  <td>2023</td>
  <td>Private Sale</td>
</tr>
...
{{< content-modules/section-header title="Tips for Buying and Selling Antique Wood Planes" level="2" >}}
...
{{< content-modules/faq title="Common Questions About Antique Wood Planes" id="faq-section" >}}
  {{< content-modules/faq-item question="How are wood planes numbered?" >}}
  ...
  {{< content-modules/faq-item question="When did Marples stop making wooden planes?" >}}
  ...
  {{< content-modules/faq-item question="What is the best wood for wooden planes?" >}}
  ...
  {{< content-modules/faq-item question="Are old wooden planes worth anything?" >}}
  ...
  {{< content-modules/faq-item question="How much is a Stanley No. 8 plane worth?" >}}
...
{{< content-modules/section-header title="Investing in Antique Wood Planes" level="2" >}}
...
{{< interactive-modules/resource-links title="External Resources for Antique Wood Plane Enthusiasts" columns="2" >}}
  {{< interactive-modules/resource-card title="Jim Bode's Value Guide to Antique Tools" url="https://www.jimbodetools.com/collections/jim-bodes-value-guide-to-antique-tools" type="guide" >}}
    A comprehensive educational resource for determining tool values, featuring visual references and price guides from an established dealer.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="AntiqBuyer Antique Woodworking Planes Guide" url="https://www.antiqbuyer.com/planes.html" type="article" >}}
    Detailed information on identifying and valuing various types of antique planes, with historical context and pricing insights.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="1stDibs Antique Wood Plane Marketplace" url="https://www.1stdibs.com/buy/antique-wood-plane/" type="tool" >}}
    Online marketplace featuring curated selections of higher-end antique wooden planes with current asking prices.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Canadian Woodworking Forum - Vintage Hand Tools" url="https://forum.canadianwoodworking.com/forum/tools/hand-tools/vintage-hand-tools/1374815-value-of-vintage-wood-planes" type="article" >}}
    Discussion forum with insights from collectors and users about the practical valuation of different plane types.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Ted Dawson Antique Tools" url="https://teddawsonantiquetools.com/collections/hand-planes" type="tool" >}}
    Specialized dealer offering curated antique planes with detailed descriptions and condition assessments.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Working Wooden Planes YouTube Channel" url="https://www.youtube.com/watch?v=BpLWK0IwV0w" type="video" >}}
    Practical advice on evaluating and purchasing antique wooden planes, including tips to avoid common pitfalls.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Carter's Antique Tool Price Guide" url="https://www.carters.com.au/index.cfm/index/3288-woodworking-tools-planes-planes-other-types/" type="guide" >}}
    Comprehensive price guide with auction results for various types of antique woodworking planes.
  {{< /interactive-modules/resource-card >}}
{{< /interactive-modules/resource-links >}}

{{< content-modules/section-header title="Conclusion: The Enduring Value of Wooden Planes" level="2" >}}
