---
title: 'Guide to Antique Cut Glass Pattern Identification: Values & History'
description: >-
  ...
  identification tips.
slug: antique-cut-glass-patterns-identification
...
image_alt: >-
  Intricate American Brilliant Period cut glass bowl showing detailed geometric
  pattern and prismatic light reflections
category: Glassware
type: article
author: Appraisily Team
featured: true
meta_title: 'Antique Cut Glass Pattern Identification Guide: Values & History'
meta_description: >-
  Master antique cut glass pattern identification with our expert guide. Learn
  to recognize American Brilliant Period designs, determine values, and
  authenticate rare pieces.
canonical_url: >-
  https://articles.appraisily.com/articles/antique-cut-glass-patterns-identification
keywords:
  - antique cut glass patterns
  - American Brilliant Period identification
  - cut glass valuation
  - vintage glass pattern recognition
  - collectible cut glass
  - antique glassware identification
  - Brilliant Period cut glass values
structured_data:
  '@context': 'https://schema.org'
  '@type': Article
  headline: 'Guide to Antique Cut Glass Pattern Identification: Values & History'
  description: >-
    Learn to identify antique cut glass patterns with our comprehensive guide.
    Discover American Brilliant Period patterns, valuation factors, and expert
    identification tips.
...
{{< content-modules/section-header title="The Rise of American Brilliant Cut Glass" level="2" >}}
...
![American Brilliant Period cut glass bowl with intricate star pattern](https://ik.imagekit.io/appraisily/SEO/antique-cut-glass-patterns-identification/antique-cut-glass-patterns-identification-image-1_NaJG-bOB1.png)
...
{{< visual-modules/timeline title="Evolution of American Cut Glass" >}}
  {{< visual-modules/timeline-item date="1876" title="Philadelphia Centennial Exhibition" >}}
  ...
  {{< visual-modules/timeline-item date="1880-1905" title="Height of the Brilliant Period" >}}
    American manufacturers perfect their craft, creating complex patterns with unprecedented precision and depth.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1908-1917" title="Decline Begins" >}}
    Rising production costs, changing tastes, and the onset of World War I lead to declining cut glass production.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="Post-1917" title="End of the Brilliant Era" >}}
...
{{< content-modules/section-header title="Characteristics of Antique Cut Glass" level="2" >}}
...
{{< content-modules/section-header title="Major Antique Cut Glass Pattern Categories" level="2" >}}
...
![Antique cut glass compote with star and hobstar pattern elements](https://ik.imagekit.io/appraisily/SEO/antique-cut-glass-patterns-identification/antique-cut-glass-patterns-identification-image-4_2hmJnsI7j.png)
...
{{< data-modules/price-table title="Antique Cut Glass Pattern Value Ranges" description="Current market values based on pattern type and condition" >}}
  <tr>
    <td>Rare Patented Patterns (Hawkes, Dorflinger)</td>
    <td>$1,000-$10,000+</td>
    <td>Museum-quality pieces in perfect condition</td>
  </tr>
  <tr>
    <td>Complex Combination Patterns</td>
    <td>$500-$2,500</td>
    <td>Excellent condition with no chips or repairs</td>
  </tr>
  <tr>
    <td>Common Hobstar or Russian Patterns</td>
    <td>$200-$800</td>
    <td>Good condition with minor wear</td>
  </tr>
  <tr>
    <td>Simple Geometric Patterns</td>
    <td>$100-$400</td>
    <td>Average condition, may have slight imperfections</td>
  </tr>
  <tr>
    <td>Late Period (1910-1920) Patterns</td>
    <td>$75-$350</td>
    <td>Less complex cutting, lighter weight glass</td>
  </tr>
...
{{< content-modules/section-header title="Identifying Specific Cut Glass Patterns" level="2" >}}
...
- Online databases like those at [cutglass.org](https://cutglass.org/) offer searchable pattern catalogs.
...
![Vintage cut glass punch bowl with prismatic properties](https://ik.imagekit.io/appraisily/SEO/antique-cut-glass-patterns-identification/antique-cut-glass-patterns-identification-image-5_vMqZo-UlB.png)

{{< content-modules/section-header title="Notable American Brilliant Period Patterns" level="2" >}}
...
{{< auction-results title="Notable Antique Cut Glass Auction Results" description="Recent significant sales of American Brilliant Period glass" >}}
  <tr>
    <td>Hawkes "Chrysanthemum" Pattern Punch Bowl Set</td>
    <td>$22,800</td>
    <td>December 2022</td>
    <td>Sotheby's</td>
  </tr>
  <tr>
    <td>Dorflinger "Parisian" Pattern Large Vase</td>
    <td>$8,400</td>
    <td>June 2023</td>
    <td>Christie's</td>
  </tr>
  <tr>
    <td>Libbey "Columbia" Pattern Water Set</td>
    <td>$6,200</td>
    <td>March 2023</td>
    <td>Heritage Auctions</td>
  </tr>
  <tr>
    <td>J. Hoare "Monarch" Pattern Centerpiece Bowl</td>
    <td>$5,800</td>
    <td>October 2022</td>
    <td>Bonhams</td>
  </tr>
  <tr>
    <td>T.B. Clark "Wheat and Barley" Pattern Decanter</td>
    <td>$4,750</td>
    <td>April 2023</td>
    <td>Skinner</td>
  </tr>
...
{{< content-modules/section-header title="Factors Affecting Antique Cut Glass Value" level="2" >}}
...
{{< content-modules/section-header title="Common Identification Challenges and Solutions" level="2" >}}
...
{{< content-modules/faq title="Common Questions About Antique Cut Glass Pattern Identification" id="faq-section" >}}
  {{< content-modules/faq-item question="What cut glass is worth money?" >}}
  ...
  {{< content-modules/faq-item question="How do you identify pressed glass patterns?" >}}
  ...
  {{< content-modules/faq-item question="How can I tell if my cut glass is American Brilliant Period?" >}}
  ...
  {{< content-modules/faq-item question="What are the most valuable antique cut glass patterns?" >}}
  ...
  {{< content-modules/faq-item question="How can I tell the difference between cut glass and crystal?" >}}
...
{{< content-modules/section-header title="Caring for Antique Cut Glass" level="2" >}}
...
{{< interactive-modules/resource-links title="External Resources for Cut Glass Pattern Identification" columns="2" >}}
  {{< interactive-modules/resource-card title="American Cut Glass Association" url="https://cutglass.org/BrilliantGlassEduc/A%20Guide%20to%20ABCG%20-%20Jim%20Havens/Part%201%20Havens/pattern1.htm" type="organization" >}}
    The official organization for American cut glass collectors, offering pattern guides, educational resources, and membership benefits including access to their extensive pattern database.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Valuable Antiques: Antique Cut Glass Patterns" url="https://valuableantiques.org/antique-cut-glass-patterns-identification-price-guide/" type="article" >}}
    Comprehensive guide to identifying and valuing antique cut glass patterns with detailed illustrations and market value information.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Pairpoint Cut Glass Pattern Database" url="http://www.pairpointcenter.com/pairpoint-cut-glass-patterns.html" type="tool" >}}
    Extensive collection of 274 original Pairpoint cut glass patterns with catalog photographs to aid in identification.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="LoveToKnow: Identify Cut Glass" url="https://www.lovetoknow.com/home/antiques-collectibles/identify-cut-glass" type="guide" >}}
    Expert guide to cut glass identification with tips on distinguishing authentic pieces from reproductions and determining value factors.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Hemswell Antiques: Guide to Glassware" url="https://www.hemswell-antiques.com/blog/what-to-look-for-in-antique-and-vintage-glassware" type="article" >}}
    Professional advice on evaluating antique and vintage glassware, including cut glass, with insights on authenticity markers and value indicators.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="J.D.S. Auctions: Cut vs. Pressed Glass Guide" url="https://www.jdsauctions.com/02/how-to-identify-types-of-crystal-glass-cut-vs-pressed/" type="tool" >}}
    Detailed comparison guide helping collectors distinguish between genuine cut glass and pressed glass imitations with visual references.
  {{< /interactive-modules/resource-card >}}
