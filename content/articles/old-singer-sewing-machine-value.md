---
title: >-
  Vintage Singer Sewing Machine Value Guide: What Your Antique Singer Is Worth
  in 2024
description: >-
...
slug: old-singer-sewing-machine-value
date: 2024-05-17T14:30:00.000Z
lastmod: 2024-05-17T14:30:00.000Z
draft: false
featured_image: >-
...
featured: true
meta_title: Antique Singer Sewing Machine Value Guide 2024 | Worth & Prices
meta_description: >-
  Discover what your old Singer sewing machine is worth in 2024. Expert
  valuation guide for vintage models including Featherweight, 66, 99, and
  treadle machines.
canonical_url: 'https://articles.appraisily.com/articles/old-singer-sewing-machine-value'
keywords:
...
{{< content-modules/section-header title="The Singer Legacy: A Brief History" level="2" >}}
Before determining value, it helps to understand Singer's remarkable history and impact on home sewing.
...
{{< visual-modules/timeline title="Singer Sewing Machine Historical Timeline" >}}
  {{< visual-modules/timeline-item date="1851" title="Singer Company Founded" >}}
    Isaac Merritt Singer establishes I.M. Singer & Company, introducing innovations that make sewing machines more practical for home use.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1856" title="First Family Machine" >}}
    Singer introduces the first successful "Family" sewing machine, making home sewing more accessible.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1889" title="Singer Model 66 Introduced" >}}
    The iconic Model 66 is released, becoming one of the most successful sewing machines ever made, with production continuing into the 1950s.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1933" title="Featherweight 221 Debuts" >}}
    The lightweight, portable Featherweight model is introduced, becoming one of the most collectible Singer machines today.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1950s-60s" title="Transition to Modern Machines" >}}
...
![Rare black Singer Featherweight sewing machine with carrying case](https://ik.imagekit.io/appraisily/SEO/old-singer-sewing-machine-value/old-singer-sewing-machine-value-image-3_KSVtSjgTi.png)

{{< content-modules/section-header title="Identifying Your Singer Sewing Machine" level="2" >}}
The first step in determining value is proper identification of your machine's model and manufacturing date.
{{< /content-modules/section-header >}}
...
Once you've located the serial number, you can use the [Singer Serial Number Database](https://ismacs.net/singer_sewing_machine_company/serial-numbers/singer-sewing-machine-serial-number-database.html) from the International Sewing Machine Collectors' Society (ISMACS) to determine your machine's manufacturing date.
...
![Singer Model 66 with Red Eye decals in excellent condition](https://ik.imagekit.io/appraisily/SEO/old-singer-sewing-machine-value/old-singer-sewing-machine-value-image-2_DFWtVpj64.png)

{{< content-modules/section-header title="Factors Affecting Vintage Singer Value" level="2" >}}
Several key elements determine how much your antique Singer sewing machine is worth.
{{< /content-modules/section-header >}}
...
![Singer treadle sewing machine in ornate cast iron stand](https://ik.imagekit.io/appraisily/SEO/old-singer-sewing-machine-value/old-singer-sewing-machine-value-image-4_jOLMT6TG7.png)

{{< content-modules/section-header title="Most Valuable Singer Sewing Machines" level="2" >}}
While most vintage Singer machines have moderate value, some models consistently command premium prices in the collector market.
{{< /content-modules/section-header >}}
...
{{< data-modules/price-table title="Vintage Singer Sewing Machine Price Ranges" description="Current market values based on recent sales (2024)" >}}
  <tr>
    <td>Singer Featherweight 221 (Standard)</td>
    <td>$400-$800</td>
    <td>Excellent condition with case</td>
  </tr>
  <tr>
    <td>Singer Featherweight 221 (Black)</td>
    <td>$900-$2,000</td>
    <td>Rare color variation</td>
  </tr>
  <tr>
    <td>Singer Model 66 "Red Eye"</td>
    <td>$300-$700</td>
    <td>Early models with intact decals</td>
  </tr>
  <tr>
    <td>Singer Model 201</td>
    <td>$250-$500</td>
    <td>Known as Singer's finest straight-stitch</td>
  </tr>
  <tr>
    <td>Singer Treadle Machines</td>
    <td>$200-$600</td>
    <td>Complete with original table</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Standard 1950s-60s Models</td>
    <td>$50-$200</td>
    <td>Common models in working condition</td>
  </tr>
  <tr>
    <td>Pre-1900 Hand Crank Models</td>
    <td>$300-$1,000</td>
    <td>Depending on rarity and condition</td>
  </tr>
{{< /data-modules/price-table >}}

![Singer sewing machine in art deco cabinet from 1950s era](https://ik.imagekit.io/appraisily/SEO/old-singer-sewing-machine-value/old-singer-sewing-machine-value-image-5_C-BdjIrcL.png)

{{< content-modules/section-header title="Common Yet Still Valuable Singer Models" level="2" >}}
Even more common vintage Singer machines can hold respectable value, especially when in excellent condition.
{{< /content-modules/section-header >}}
...
After identifying your model and assessing its condition, it's time to research current market values.
{{< /content-modules/section-header >}}
...
- **Singer collectors' forums**: Websites like [The Quilting Board](https://www.quiltingboard.com/) have dedicated vintage machine sections
- **International Sewing Machine Collectors' Society**: The [ISMACS website](https://ismacs.net/) offers valuable resources for identification and valuation
- **Singer's official resources**: Singer maintains information about [vintage machine value](https://www.singer.com/pages/sewing-machine-value-what-is-your-sewing-machine-worth)
...
- Online appraisal services like [Mearto](https://www.mearto.com/categories/singer-sewing-machines)
...
{{< interactive-modules/resource-links title="External Singer Sewing Machine Resources" columns="2" >}}
  {{< interactive-modules/resource-card title="Singer Serial Number Database" url="https://ismacs.net/singer_sewing_machine_company/serial-numbers/singer-sewing-machine-serial-number-database.html" type="tool" >}}
  ...
  {{< interactive-modules/resource-card title="eBay Collectible Singer Machines" url="https://www.ebay.com/b/Old-Singer-Sewing-Machine-In-Collectible-Sewing-Machines/605/bn_7022254219" type="marketplace" >}}
    Browse current listings and recently sold items to gauge the current market value of similar Singer machines to yours.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="The Quilting Board" url="https://www.quiltingboard.com/vintage-antique-machine-enthusiasts-f22/" type="forum" >}}
  ...
  {{< interactive-modules/resource-card title="Singer Featherweight Shop" url="https://singer-featherweight.com/" type="marketplace" >}}
...
Should you restore your vintage Singer or leave it as is? The answer depends on several factors.
{{< /content-modules/section-header >}}
...
{{< content-modules/faq title="Frequently Asked Questions About Vintage Singer Sewing Machine Values" id="singer-value-faqs" >}}
  ...
  {{< content-modules/faq-item question="What is the most valuable Singer sewing machine?" >}}
    ...
    1. The Singer 222K Free-Arm Featherweight, which can sell for $1,500-$4,000 due to its rarity
    2. Rare black Singer Featherweight 221 models in excellent condition with original case and accessories ($900-$2,000)
    3. The Singer "Turtleback" from the 1870s ($1,000-$3,000)
    4. Pre-1900 models with unusual features or in exceptional condition
  ...
  {{< content-modules/faq-item question="Are Singer sewing machines from the 1950s and 1960s worth anything?" >}}
  ...
  {{< content-modules/faq-item question="How can I tell if my Singer is a rare or valuable model?" >}}
    To identify potentially rare or valuable Singer models:
    
    1. Look up the serial number to determine the model and manufacturing date
    2. Research specific features like unusual decals, rare color variants, or special editions
    3. Check for models known to be valuable (like the Featherweight 221, Model 66 "Red Eye," or pre-1900 models)
    4. Assess the overall condition, as even common models in pristine condition can be valuable
    5. Look for complete original accessories, case, and documentation
    
    Consulting with collectors' forums or getting a professional appraisal is recommended for potentially valuable machines.
  {{< /content-modules/faq-item >}}
  
  {{< content-modules/faq-item question="Does restoring my Singer sewing machine increase or decrease its value?" >}}
    The impact of restoration depends on several factors:
  ...
  {{< content-modules/faq-item question="What's the value of a Singer sewing machine in a wooden cabinet?" >}}
  ...
  {{< content-modules/faq-item question="Where is the best place to sell a vintage Singer sewing machine?" >}}
  ...
  {{< content-modules/faq-item question="How important are original accessories to a Singer sewing machine's value?" >}}
