---
title: 'Old Mason Jars Value Guide: Identify Rare Antique Canning Jars Worth Money'
description: >-
...
image_alt: >-
  Valuable antique Mason jars collection showing rare Ball and Atlas models in
  blue, amber and clear glass with various closures
category: Glassware
type: article
author: Appraisily Team
featured: true
meta_title: 'Old Mason Jars Value Guide: Find Rare Antique Jars Worth Money'
meta_description: >-
  Discover which vintage Mason jars are valuable collectibles worth $15-$1000+.
  Learn to identify rare colors, unique markings, and how to date antique
  canning jars like Ball and Atlas.
canonical_url: 'https://articles.appraisily.com/articles/value-of-old-mason-jars'
keywords:
  - antique mason jar values
  - rare mason jars worth money
  - vintage ball mason jars
  - colored mason jar identification
  - collectible canning jars
  - atlas mason jar prices
  - valuable antique glass jars
structured_data:
  '@context': 'https://schema.org'
  '@type': Article
  headline: 'Old Mason Jars Value Guide: Identify Rare Antique Canning Jars Worth Money'
  description: >-
    Discover the value of old Mason jars with our comprehensive guide. Learn to
    identify rare jars worth hundreds, dating techniques, and where to sell your
    vintage collection.
  ...
  mainEntityOfPage:
    '@type': WebPage
    '@id': 'https://articles.appraisily.com/articles/value-of-old-mason-jars'
---

![Collection of vintage Ball and Atlas Mason jars in various colors and styles](https://ik.imagekit.io/appraisily/SEO/value-of-old-mason-jars/value-of-old-mason-jars-image-1_eQThLY7D-.png)
...
{{< content-modules/section-header title="The Origins of Mason Jars" level="2" >}}
Before diving into valuation, understanding the rich history of Mason jars provides crucial context for collectors and sellers alike.
...
{{< visual-modules/timeline title="Evolution of Mason Jar Production" >}}
  ...
  {{< visual-modules/timeline-item date="1884" title="Ball Enters the Market" >}}
    The Ball brothers begin manufacturing glass jars in Buffalo, NY.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1886" title="Ball Relocates" >}}
    Ball brothers move production to Muncie, Indiana, which becomes known as "Jar City."
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1904" title="Atlas Glass Company" >}}
    Atlas Glass Company forms, becoming a major competitor in the Mason jar market.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1940s" title="Modern Design Changes" >}}
...
{{< content-modules/section-header title="Dating Your Antique Jars" level="2" >}}
The age of a Mason jar is one of the primary factors in determining its value. Learn to recognize key features that help date your vintage jars.
{{< /content-modules/section-header >}}

![Various vintage Ball Mason jars with different logo styles and colors](https://ik.imagekit.io/appraisily/SEO/value-of-old-mason-jars/value-of-old-mason-jars-image-2_bk6dlGdC9.png)
...
{{< content-modules/section-header title="High-Value Mason Jar Varieties" level="2" >}}
While most vintage Mason jars have modest value, certain rare types can be worth hundreds or even thousands of dollars to serious collectors.
{{< /content-modules/section-header >}}

![Close-up of a rare amber Ball Mason jar against white background](https://ik.imagekit.io/appraisily/SEO/value-of-old-mason-jars/value-of-old-mason-jars-image-3_k_Q5JrCiy.png)
...
{{< data-modules/price-table title="Value by Glass Color" description="Current market values for colored Mason jars" >}}
  <tr>
    <td>Amber/Yellow</td>
    <td>$100-$500</td>
    <td>Uncommon color from 1910-1920s</td>
  </tr>
  <tr>
    <td>Olive Green</td>
    <td>$300-$800</td>
    <td>Very rare, especially in quart size</td>
  </tr>
  <tr>
    <td>Black Amethyst</td>
    <td>$400-$1,000+</td>
    <td>Extremely rare, deep purple appearance</td>
  </tr>
  <tr>
    <td>Cobalt Blue</td>
    <td>$500-$2,500+</td>
    <td>Highly sought after, produced for short period</td>
  </tr>
  <tr>
    <td>Red</td>
    <td>$1,000-$3,000+</td>
    <td>Exceptionally rare color</td>
  </tr>
{{< /data-modules/price-table >}}

According to a Country Living Magazine article, certain exceptionally rare colored Mason jars have sold for up to $500 individually, with the jar's color being the primary value driver.
...
{{< auction-results title="Notable Mason Jar Auction Results" description="Recent high-value antique jar sales" >}}
  <tr>
    <td>F.C. Van Vliet Improved</td>
    <td>$23,500</td>
    <td>November 2020</td>
  ...
  <tr>
    <td>Black Amber Half-Gallon</td>
    <td>$1,800</td>
    <td>February 2023</td>
    <td>eBay</td>
  </tr>
  <tr>
    <td>Green Beaver Jar with Original Lid</td>
    <td>$1,200</td>
    <td>January 2023</td>
    <td>Collector's Weekly</td>
  </tr>
{{< /auction-results >}}

## Determining Mason Jar Value Factors

{{< content-modules/section-header title="Value Assessment Criteria" level="2" >}}
Multiple factors beyond age affect the value of antique Mason jars. Understanding these elements helps collectors make informed buying and selling decisions.
{{< /content-modules/section-header >}}

![Assortment of Mason jars in different conditions and with various closures](https://ik.imagekit.io/appraisily/SEO/value-of-old-mason-jars/value-of-old-mason-jars-image-4_4d4reHImo.png)
...
{{< content-modules/section-header title="Atlas Mason Jar Collectibility" level="2" >}}
While Ball jars receive most of the attention, Atlas produced distinctive jars that have their own collecting community and value profiles.
{{< /content-modules/section-header >}}
...
{{< content-modules/section-header title="Ball Jar Dating & Valuation" level="2" >}}
Ball jars are the most common and widely collected Mason jars. This chronological guide helps date and value your Ball jar collection.
{{< /content-modules/section-header >}}
...
{{< data-modules/price-table title="Ball Mason Jar Value by Era" description="Approximate values based on typical examples in good condition" >}}
  <tr>
    <td>1885-1886 (Bracket & Underscore)</td>
    <td>$75-$150+</td>
    <td>Very rare, earliest Ball jars</td>
  </tr>
  <tr>
    <td>1888-1894 (Simple Underscore)</td>
    <td>$50-$100</td>
    <td>Early period, relatively rare</td>
  </tr>
  <tr>
    <td>1895-1896 (Dropped "a")</td>
    <td>$40-$80</td>
    <td>Short production window, distinctive</td>
  </tr>
  <tr>
    <td>1896-1910 (Block Letters)</td>
    <td>$20-$50</td>
    <td>More common but still antique</td>
  </tr>
  <tr>
    <td>1910-1923 (Looped B)</td>
    <td>$15-$35</td>
    <td>Distinctive loop on "B"</td>
  </tr>
  <tr>
    <td>1923-1933 (3-L Style)</td>
    <td>$8-$25</td>
    <td>Very common vintage jars</td>
  </tr>
  <tr>
    <td>1933-1962 (No Underscore)</td>
    <td>$5-$15</td>
    <td>Most common vintage Ball jars</td>
  </tr>
{{< /data-modules/price-table >}}

It's important to note that these values represent common clear or aqua blue examples in good condition. Rare colors, perfect condition, or unusual features can multiply these base values significantly.

![Close-up of vintage Ball Mason jar showing logo detail and text embossing](https://ik.imagekit.io/appraisily/SEO/value-of-old-mason-jars/value-of-old-mason-jars-image-5_Dx0hwyLF_.png)

## Where to Sell Valuable Mason Jars

{{< content-modules/section-header title="Selling Your Vintage Jars" level="2" >}}
Once you've identified a potentially valuable jar, knowing where to sell can make a significant difference in realizing its full value.
{{< /content-modules/section-header >}}
...
{{< content-modules/faq title="Common Questions About Antique Mason Jars" id="mason-jar-faq" >}}
  {{< content-modules/faq-item question="How can you tell if old Mason jars are valuable?" >}}
  ...
  {{< content-modules/faq-item question="What do the numbers on the bottom of a mason jar mean?" >}}
  ...
  {{< content-modules/faq-item question="What are the most valuable Ball Mason jars?" >}}
  ...
  {{< content-modules/faq-item question="Are Ball Mason jars from the 1920s-1930s valuable?" >}}
  ...
  {{< content-modules/faq-item question="How do I clean old Mason jars without damaging them?" >}}
...
{{< interactive-modules/resource-links title="Mason Jar Collector Resources" columns="2" description="Explore these trusted sources for more information on collecting and valuing antique Mason jars" >}}
  {{< interactive-modules/resource-card title="Ball Mason Jar Age Chart" url="https://www.tasteofhome.com/article/ball-mason-jar-age-chart/" type="guide" >}}
    Comprehensive guide to dating vintage Ball Mason jars using logo styles and other identifying features.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="America's Antique Mall: Guide to Dating and Collecting Antique Jars" url="https://www.americasantiquemall.com/post/the-expert-guide-to-dating-and-collecting-antique-jars" type="article" >}}
    Expert insights on identifying, dating, and valuing antique canning jars of various manufacturers.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Minnetrista: How to Date a Ball Jar" url="https://www.minnetrista.net/blog/blog/2013/06/27/ball-family-history/how-to-date-a-ball-jar" type="article" >}}
    Dating guide from the cultural center that houses the Ball Corporation archives in Muncie, Indiana.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Atlas Mason Jar Values & Five Jars to Look For" url="https://www.yahoo.com/lifestyle/atlas-mason-jar-values-five-132100721.html" type="article" >}}
    Detailed information specifically about Atlas jars and their current market values.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Mason Jar Merchant: Vintage Mason Jars" url="https://masonjarmerchant.com/collections/vintage-mason-jars" type="shop" >}}
    Online retailer specializing in vintage Mason jars, provides market value examples.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="eBay: Antique Canning Jars" url="https://www.ebay.com/b/Antique-Canning-Jars-In-Collectible-Jars-1900-Now/13913/bn_7022427954" type="tool" >}}
    Browse current listings and completed sales to understand the current market for antique Mason jars.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Country Living: Valuable Mason Jars Guide" url="https://www.countryliving.com/shopping/antiques/a64128051/antique-mason-jar-value/" type="article" >}}
    Illustrated guide to identifying particularly valuable Mason jars, including those worth $500 or more.
  {{< /interactive-modules/resource-card >}}
