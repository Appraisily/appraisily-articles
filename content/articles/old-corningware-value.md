---
title: 'Vintage CorningWare Value Guide: What Your Old Pieces Are Worth in 2024'
description: >-
...
slug: old-corningware-value
date: 2024-07-15T14:30:00.000Z
lastmod: 2024-07-15T14:30:00.000Z
draft: false
featured_image: 'https://ik.imagekit.io/appraisily/appraisily-default-image.jpg'
image_alt: >-
  Collection of vintage CorningWare pieces featuring the iconic Blue Cornflower
  pattern and Pyrex lids
category: Kitchenware & Cookware
type: article
author: Appraisily Team
featured: true
meta_title: 'Vintage CorningWare Value Guide: What Old Pieces Are Worth in 2024'
meta_description: >-
  Discover what makes vintage CorningWare valuable in 2024. Learn to identify
  rare patterns like Blue Cornflower and La Marjolaine that could be worth
  thousands in this collector's guide.
canonical_url: 'https://articles.appraisily.com/articles/old-corningware-value'
keywords:
...
structured_data:
  ...
  '@type': Article
  headline: 'Vintage CorningWare Value Guide: What Your Old Pieces Are Worth in 2024'
  description: >-
    Discover the true value of your vintage CorningWare cookware. From rare
    patterns worth thousands to common designs, learn what makes these retro
    kitchen pieces collectible.
...
{{< content-modules/section-header title="The CorningWare Story: From Space Age to Kitchen Staple" level="2" >}}
Before diving into values, let's understand what makes CorningWare special and why it's become such a sought-after collectible.
...
{{< visual-modules/timeline title="CorningWare History Timeline" >}}
  {{< visual-modules/timeline-item date="1958" title="First CorningWare Introduction" >}}
  ...
  {{< visual-modules/timeline-item date="1958-1960s" title="Blue Cornflower Dominance" >}}
...
{{< content-modules/section-header title="Identifying Valuable Vintage CorningWare" level="2" >}}
Not all CorningWare pieces are created equal. Here's how to identify potentially valuable items in your collection.
{{< /content-modules/section-header >}}
...
{{< data-modules/price-table title="Valuable CorningWare Patterns" description="Most sought-after designs by collectors" >}}
  <tr>
    <td>Pattern</td>
  ...
  <tr>
    <td>Blue Cornflower</td>
    <td>1958-1988</td>
    <td>$20-$150 for common pieces</td>
    <td>Extremely common but still desirable</td>
  </tr>
  <tr>
    <td>Floral Bouquet</td>
    <td>1971-1975</td>
    <td>$50-$300</td>
    <td>Limited production makes this more valuable</td>
  </tr>
  <tr>
    <td>Spice O' Life (La Marjolaine)</td>
    <td>1972-1987</td>
    <td>$15-$200</td>
    <td>Popular pattern with moderate value</td>
  </tr>
  <tr>
    <td>Wildflower</td>
    <td>1977-1984</td>
    <td>$30-$200</td>
    <td>Shorter production run increases desirability</td>
  </tr>
  <tr>
    <td>Black Starburst (Atomic)</td>
    <td>1959-1963</td>
    <td>$500-$4,000</td>
    <td>Extremely rare and highly sought after</td>
  </tr>
  <tr>
    <td>Blue Medallion</td>
    <td>1976-1977</td>
    <td>$200-$2,000</td>
    <td>Very limited production run</td>
  </tr>
  <tr>
    <td>Wheat</td>
    <td>1958-1960</td>
    <td>$800-$3,000</td>
    <td>The first pattern produced, extremely rare</td>
  </tr>
...
{{< data-modules/stats-highlight title="CorningWare Value Facts" columns="3" / / />}}

{{< content-modules/section-header title="The $10,000 CorningWare Myth" level="2" >}}
Let's address the viral social media claims about extremely valuable CorningWare and separate fact from fiction.
{{< /content-modules/section-header >}}
...
As noted in a [Reddit discussion](https://www.reddit.com/r/whatsthisworth/comments/eqa9sr/i_heard_that_corningware_is_worth_a_lot_do_i_have/), most standard CorningWare pieces are "garden variety" and may only fetch $10-20 each, not the dramatic figures sometimes reported.

{{< content-modules/section-header title="Factors That Impact CorningWare Value" level="2" >}}
Beyond pattern and piece type, several other factors significantly influence what collectors are willing to pay.
{{< /content-modules/section-header >}}
...
Real-world examples of what vintage CorningWare has sold for can provide a realistic perspective on values.
{{< /content-modules/section-header >}}
...
{{< auction-results title="Recent Vintage CorningWare Sales" description="Verified auction and marketplace results" >}}
  <tr>
    <td>Black Starburst (Atomic) 1.5qt Casserole with lid</td>
    <td>$2,750</td>
    <td>May 2024</td>
    <td>eBay</td>
  </tr>
  <tr>
    <td>Complete 10-piece Blue Cornflower Set</td>
    <td>$325</td>
    <td>March 2024</td>
    <td>Etsy</td>
  </tr>
  <tr>
    <td>Blue Medallion 2qt Casserole with lid</td>
    <td>$895</td>
    <td>February 2024</td>
    <td>Online Auction</td>
  </tr>
  <tr>
    <td>Spice O' Life Complete 5-piece Set</td>
    <td>$175</td>
    <td>April 2024</td>
    <td>Antique Mall</td>
  </tr>
  <tr>
    <td>Electromatic E-4 Skillet, Blue Cornflower</td>
    <td>$450</td>
    <td>January 2024</td>
    <td>Specialty Collector Site</td>
  </tr>
  <tr>
    <td>Wheat Pattern 2.5qt Casserole (early production)</td>
    <td>$1,800</td>
    <td>December 2023</td>
    <td>Vintage Cookware Auction</td>
  </tr>
{{< /auction-results >}}

According to [JustAnswer appraisals](https://www.justanswer.com/appraisals/nbp2r-purchased-corningware-dish-wanted-know.html), 1970s Corning Ware with Pyrex glass lids is typically valued at $15 to $25 for each casserole dish, considerably less than viral reports suggest.

{{< content-modules/section-header title="Where to Sell Vintage CorningWare" level="2" >}}
If you've determined you have valuable pieces, here are the best venues for selling them.
{{< /content-modules/section-header >}}
...
{{< content-modules/section-header title="Caring for Valuable CorningWare" level="2" >}}
Proper care can help maintain or increase the value of your vintage pieces.
{{< /content-modules/section-header >}}
...
{{< content-modules/section-header title="CorningWare Authentication Tips" level="2" >}}
How to ensure you're getting authentic vintage pieces and not reproductions or newer versions.
{{< /content-modules/section-header >}}
...
{{< content-modules/faq title="Frequently Asked Questions About Vintage CorningWare Value" id="faq-section" >}}
  ...
  {{< content-modules/faq-item question="How much is La Marjolaine (Spice O' Life) CorningWare worth?" >}}
  ...
  {{< content-modules/faq-item question="What year was Blue Cornflower CorningWare first produced?" >}}
  ...
  {{< content-modules/faq-item question="Are newer CorningWare pieces worth anything?" >}}
  ...
  {{< content-modules/faq-item question="What's the difference between CorningWare and Pyrex?" >}}
  ...
  {{< content-modules/faq-item question="Is it safe to use vintage CorningWare for cooking?" >}}
  ...
  {{< content-modules/faq-item question="Where is the best place to find valuable vintage CorningWare?" >}}
...
Realistic expectations and next steps for your vintage kitchen items.
{{< /content-modules/section-header >}}
...
{{< interactive-modules/resource-links title="External Resources for CorningWare Collectors" columns="2" >}}
  {{< interactive-modules/resource-card title="Taste of Home: Vintage CorningWare Value Guide" url="https://www.tasteofhome.com/article/vintage-corningware/" type="article" >}}
    Comprehensive guide to identifying valuable CorningWare patterns and understanding what makes certain pieces worth thousands.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="CorningWare History on Wikipedia" url="https://en.wikipedia.org/wiki/CorningWare" type="article" >}}
    Detailed historical information about CorningWare development, manufacturing technology, and pattern chronology.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Reddit: CorningWare Value Discussion" url="https://www.reddit.com/r/whatsthisworth/comments/eqa9sr/i_heard_that_corningware_is_worth_a_lot_do_i_have/" type="forum" >}}
    Real discussions from collectors about realistic values of common CorningWare pieces and pattern identification.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="JustAnswer: Expert CorningWare Appraisals" url="https://www.justanswer.com/appraisals/nbp2r-purchased-corningware-dish-wanted-know.html" type="tool" >}}
    Professional appraisal information about specific CorningWare patterns and their current market values.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="LoveToKnow: Vintage CorningWare Patterns & Values" url="https://www.lovetoknow.com/home/antiques-collectibles/vintage-corningware" type="guide" >}}
    Detailed pattern guide with photographs to help identify specific CorningWare designs and their corresponding values.
  {{< /interactive-modules/resource-card >}}
  ...
  {{< interactive-modules/resource-card title="Dr. Lori's YouTube Guide to Rare CorningWare" url="https://www.youtube.com/watch?v=Z8CodhoNN2k" type="video" >}}
    Video guide from antiques expert Dr. Lori on identifying rare and valuable CorningWare patterns while thrift shopping.
  {{< /interactive-modules/resource-card >}}

  {{< interactive-modules/resource-card title="Home Beautiful: Valuable CorningWare Guide" url="https://www.homebeautiful.com.au/your-corningware-could-be-worth-thousands-of-dollars" type="article" >}}
    Article highlighting which specific CorningWare patterns are commanding the highest prices at auction.
  {{< /interactive-modules/resource-card >}}
