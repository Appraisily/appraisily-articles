---
title: 'Old Company Plate Value: The Ultimate Guide to Silverplate Valuation'
description: >-
  Discover the true value of Old Company Plate silverware. Learn identification
  marks, price factors, and what makes this vintage silverplate worth collecting
  or selling.
slug: old-company-plate-value
...
featured: true
meta_title: 'Old Company Plate Value: What Is Your Vintage Silverware Worth?'
meta_description: >-
  Discover the true value of your Old Company Plate silverware. Our expert guide
  covers identification marks, pricing factors, and where to sell these
  collectible silver-plated pieces.
canonical_url: 'https://articles.appraisily.com/articles/old-company-plate-value'
keywords:
...
structured_data:
  ...
  '@type': Article
  headline: 'Old Company Plate Value: The Ultimate Guide to Silverplate Valuation'
  description: >-
...
![A pristine set of Old Company Plate silverware with signature hallmark visible](https://ik.imagekit.io/appraisily/SEO/old-company-plate-value/old-company-plate-value-image-1_JbdIHiRK5.png)

## What is Old Company Plate?

{{< content-modules/section-header title="Understanding Old Company Plate" level="2" >}}
...
{{< visual-modules/timeline title="Old Company Plate History" >}}
  {{< visual-modules/timeline-item date="Late 1800s" title="International Silver Company Founded" >}}
  ...
  {{< visual-modules/timeline-item date="1940s" title="Old Company Plate Introduction" >}}
  ...
  {{< visual-modules/timeline-item date="1970s-1980s" title="Decline in Production" >}}
...
![Close-up of the Old Company Plate hallmark on flatware](https://ik.imagekit.io/appraisily/SEO/old-company-plate-value/old-company-plate-value-image-2_gYI7VwllF.png)
...
![A complete service of Old Company Plate silverware in original storage box](https://ik.imagekit.io/appraisily/SEO/old-company-plate-value/old-company-plate-value-image-3_JMkwmlCqq.png)
...
{{< data-modules/price-table title="Old Company Plate Value Ranges" description="Current market values based on condition and completeness (2024)" >}}
  <tr>
    <td>Single Piece (Fork, Spoon, etc.)</td>
    <td>$2-$10</td>
  ...
  <tr>
    ...
    <td>$10-$25</td>
    <td>Meat forks, serving spoons command higher prices</td>
  </tr>
  <tr>
    <td>4-Piece Place Setting</td>
    <td>$15-$30</td>
    <td>Signature pattern in good condition</td>
  </tr>
  <tr>
    <td>Service for 8 (32 pieces)</td>
    <td>$75-$150</td>
    <td>Complete set in original box adds value</td>
  </tr>
  <tr>
    <td>Service for 12 (48+ pieces)</td>
    <td>$100-$250</td>
    <td>Excellent condition with full complement of serving pieces</td>
  </tr>
  <tr>
    <td>Large Complete Set (100+ pieces)</td>
    <td>$200-$600</td>
    <td>Pristine condition with original storage box</td>
  </tr>
...
According to [JustAnswer's antiques expert](https://www.justanswer.com/antiques/5k1gr-some-old-company-plate-flat-ware.html), a full set of Old Company Plate flatware in excellent condition has a retail replacement value of approximately $600 on the high end. However, most sets on the secondary market will sell for considerably less.

![A complete Old Company Plate Signature pattern place setting](https://ik.imagekit.io/appraisily/SEO/old-company-plate-value/old-company-plate-value-image-4_VYgJru1lH.png)
...
1. **Online Marketplaces**
   - eBay has numerous listings for [Old Company Plate flatware](https://www.ebay.com/b/Old-Company-Plate-Antique-US-Silver-Plated-Flatware/20099/bn_99087257)
...
2. **Specialty Retailers**
   - [Antique Cupboard](https://antiquecupboard.com/Signature--With-Monograms-by-Old-Company-Plate-frasl-Int--Silver-Plate_c_30406.html) specializes in silverware patterns including Old Company Plate
   - [The Sterling Shop](https://www.sterlingshop.com/category_s/880.htm) offers both complete sets and individual pieces

3. **Auction Houses and Estate Sales**
   - Live auctions occasionally feature Old Company Plate, such as [this 48-piece set](https://www.liveauctioneers.com/price-result/48-pcs-old-company-plate-flatware-set/)
...
![Old Company Plate serving pieces displayed on dining table](https://ik.imagekit.io/appraisily/SEO/old-company-plate-value/old-company-plate-value-image-5_g5QBCGKzC.png)

## Caring for Old Company Plate

{{< content-modules/section-header title="Maintenance and Restoration" level="2" >}}
...
{{< content-modules/faq title="Common Questions About Old Company Plate Value" id="faq-section" >}}
  {{< content-modules/faq-item question="Is Old Company Plate real silver?" >}}
  ...
  {{< content-modules/faq-item question="How can I tell if my Old Company Plate is valuable?" >}}
  ...
  {{< content-modules/faq-item question="Does Old Company Plate have any scrap value?" >}}
  ...
  {{< content-modules/faq-item question="Where can I sell my Old Company Plate silverware?" >}}
  ...
  {{< content-modules/faq-item question="How do I clean Old Company Plate without damaging it?" >}}
    Clean gently using:
  ...
  {{< content-modules/faq-item question="Does monogrammed Old Company Plate have less value?" >}}
...
{{< interactive-modules/resource-links title="Helpful Resources for Old Company Plate Collectors" columns="2" >}}
  {{< interactive-modules/resource-card title="Replacements, Ltd. Pattern Database" url="https://www.replacements.com/silver" type="tool" >}}
    Comprehensive database of silverware patterns including Old Company Plate, with current retail prices for replacement pieces.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Antique Cupboard Old Company Plate Listings" url="https://antiquecupboard.com/Signature--With-Monograms-by-Old-Company-Plate-frasl-Int--Silver-Plate_c_30406.html" type="resource" >}}
    Specialized seller with detailed information about Old Company Plate patterns and current market prices.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Silver Pattern Matching Database" url="http://silverpattern.com/i/silverplate-patterns/signature-1950-by-old-company-plate-monogrammed" type="tool" >}}
    Help identifying specific Old Company Plate patterns including the popular Signature design.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Hemswell Antiques Guide to Silver vs. Silver Plate" url="https://www.hemswell-antiques.com/blog/antique-silver-and-antique-silver-plate-what-s-the-difference" type="article" >}}
    Detailed explanation of the differences between sterling silver and silver-plated items like Old Company Plate.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="eBay Old Company Plate Collection" url="https://www.ebay.com/b/Old-Company-Plate-Antique-US-Silver-Plated-Flatware/20099/bn_99087257" type="marketplace" >}}
    Current listings showing market prices and available patterns for Old Company Plate silverware.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Collector's Journal: Silver Plate Scrap Value" url="https://www.collectorsjournal.com/columns/does-silverplate-have-any-scrap-value/article_817b4bb6-7b04-11e9-a2fb-9f6a266d1b52.html" type="article" >}}
    Expert information on the scrap value of silver-plated items and why they're more valuable intact than melted down.
  {{< /interactive-modules/resource-card >}}
