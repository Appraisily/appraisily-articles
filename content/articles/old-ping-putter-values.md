---
title: 'Vintage PING Putter Values: Collector''s Guide to Rare Models & Pricing'
description: >-
  Discover what makes old PING putters valuable, from rare Scottsdale models to
  Redwood City classics. Learn how to identify collectible putters and get
  current market values.
slug: old-ping-putter-values
...
image_alt: >-
  Vintage PING Anser putter from the Scottsdale era showing authentic patina and
  original grip
category: Sports Memorabilia
type: article
author: Appraisily Team
featured: true
meta_title: 'Vintage PING Putter Values: Collector''s Guide to Rare Models'
meta_description: >-
  Discover what makes old PING putters valuable, from rare Scottsdale and
  Redwood City models to beryllium copper designs. Current market values for
  collectors.
canonical_url: 'https://articles.appraisily.com/articles/old-ping-putter-values'
keywords:
...
structured_data:
  ...
  description: >-
    Expert guide to old PING putter values with pricing for rare Scottsdale,
    Redwood City, and beryllium models. Learn what makes vintage PING putters
    valuable.
  author:
    '@type': Organization
...
![Vintage PING Anser putter from Scottsdale era with original grip and patina](https://ik.imagekit.io/appraisily/SEO/old-ping-putter-values/old-ping-putter-values-image-1_szxwR6eMT.png)
...
- **Material:** Beryllium copper models command significant premiums

{{< visual-modules/timeline title="PING Putter Historical Timeline" >}}
  {{< visual-modules/timeline-item date="1959" title="Beginning of PING" >}}
  ...
  {{< visual-modules/timeline-item date="1966" title="PING Anser Introduction" >}}
  ...
  {{< visual-modules/timeline-item date="1980s" title="Beryllium Copper Models" >}}
    Introduction of beryllium copper putters, which would become highly sought after by collectors.
  {{< /visual-modules/timeline-item >}}
{{< /visual-modules/timeline >}}

{{< content-modules/section-header title="What Makes Old PING Putters Valuable?" level="2" >}}
...
![Rare beryllium copper PING putter showing distinctive coloration and patina](https://ik.imagekit.io/appraisily/SEO/old-ping-putter-values/old-ping-putter-values-image-2_PWZs57Dv25.png)
...
{{< content-modules/section-header title="How to Identify Valuable PING Putters" level="2" >}}
...
![Close-up of PING putter showing serial number location and manufacturing stamps](https://ik.imagekit.io/appraisily/SEO/old-ping-putter-values/old-ping-putter-values-image-3_q8Xa9Jck_5.png)
...
![Collection of multiple vintage PING putters showing different models and eras](https://ik.imagekit.io/appraisily/SEO/old-ping-putter-values/old-ping-putter-values-image-4_O49ICQqTp.png)

{{< data-modules/price-table title="Vintage PING Putter Value Guide" description="Current market values as of 2023" >}}
  <tr>
    <td>Redwood City PING Putters (Any Model)</td>
    <td>$1,000 - $3,000+</td>
    <td>Extremely rare, highest collector value</td>
  </tr>
  <tr>
    <td>Scottsdale PING Anser (with ZIP code)</td>
    <td>$150 - $500</td>
    <td>Higher value for excellent condition</td>
  </tr>
  <tr>
    <td>Beryllium Copper PING Putters</td>
    <td>$200 - $1,000+</td>
    <td>Premium for original condition BeCu models</td>
  </tr>
  <tr>
    <td>Scottsdale PING Anser (no ZIP code)</td>
    <td>$50 - $120</td>
    <td>Common but still collectible</td>
  </tr>
  <tr>
    <td>PING 1-A Original Models</td>
    <td>$90 - $200</td>
    <td>Historical significance adds value</td>
  </tr>
  <tr>
    <td>Later PING Models (1980s-1990s)</td>
    <td>$20 - $65</td>
    <td>Common models in average condition</td>
  </tr>
  <tr>
    <td>Modern PING Putters (Used)</td>
    <td>$60 - $135</td>
    <td>Based on condition and model</td>
  </tr>
{{< /data-modules/price-table >}}

### Recent Auction Examples

{{< auction-results title="Notable PING Putter Auction Sales" description="Recent sales from online marketplaces and auction houses" >}}
  <tr>
    <td>PING Anser Redwood City</td>
    <td>$2,350</td>
    <td>February 2023</td>
    <td>eBay</td>
  </tr>
  <tr>
    <td>PING Anser Scottsdale (with ZIP)</td>
    <td>$425</td>
    <td>January 2023</td>
    <td>GolfWRX Forum</td>
  </tr>
  <tr>
    <td>PING Beryllium Copper Anser</td>
    <td>$750</td>
    <td>March 2023</td>
    <td>Specialized Golf Auction</td>
  </tr>
  <tr>
    <td>PING 1-A Original</td>
    <td>$185</td>
    <td>December 2022</td>
    <td>eBay</td>
  </tr>
  <tr>
    <td>PING Anser 2 (1980s model)</td>
    <td>$65</td>
    <td>April 2023</td>
...
{{< content-modules/section-header title="Where to Sell Vintage PING Putters" level="2" >}}
...
![Vintage PING putter in original condition with patina and wood shaft](https://ik.imagekit.io/appraisily/SEO/old-ping-putter-values/old-ping-putter-values-image-5_sK2J0RJaZJ.png)
...
{{< content-modules/section-header title="Tips for Collecting Vintage PING Putters" level="2" >}}
...
{{< content-modules/faq title="Common Questions About Vintage PING Putter Values" id="faq-section" >}}
  {{< content-modules/faq-item question="Where is the serial number on a PING putter?" >}}
  ...
  {{< content-modules/faq-item question="What are old PING putters made of?" >}}
  ...
  {{< content-modules/faq-item question="How much is a Scottsdale PING putter worth?" >}}
  ...
  {{< content-modules/faq-item question="What does a green dot mean on a PING putter?" >}}
  ...
  {{< content-modules/faq-item question="How can I tell how old my PING putter is?" >}}
  ...
  {{< content-modules/faq-item question="Are PING Anser putters valuable?" >}}
  ...
  {{< content-modules/faq-item question="How do I sell my vintage PING putter?" >}}
...
{{< interactive-modules/resource-links title="External Resources for PING Putter Values" columns="2" >}}
  {{< interactive-modules/resource-card title="GolfWRX Forums - PING Putter Discussion" url="https://forums.golfwrx.com/topic/769818-where-do-you-find-values-for-old-ping-putters/" type="forum" >}}
    Active community of golf enthusiasts and collectors discussing PING putter values, identification, and the market for rare models.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="eBay PING Vintage Putter Collection" url="https://www.ebay.com/b/PING-Putter-Vintage-Golf-Clubs/115280/bn_7023429797" type="marketplace" >}}
    Browse current listings and recently sold PING putters to gauge current market values and available inventory.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="PING Club Repair and Serial Number Information" url="https://ping.com/en-us/club-repair" type="official" >}}
    Official PING resource for club identification, including information about serial number locations and club authentication.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="The Sand Trap - Vintage PING Putter Discussions" url="https://thesandtrap.com/forums/topic/24200-what-is-an-old-ping-anser-worth/" type="forum" >}}
    Golf community with detailed threads about vintage PING putter values and collector insights.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Reddit r/PingGolf Community" url="https://www.reddit.com/r/PingGolf/comments/1bvtz8w/help_identify_value_of_dads_old_putter/" type="forum" >}}
    Active Reddit community focused on PING equipment, including vintage putter identification and valuation discussions.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="2nd Swing Golf - PING Putter Inventory" url="https://www.2ndswing.com/golf-clubs/ping/putters" type="marketplace" >}}
    Specialized golf retailer with extensive inventory of new and used PING putters, offering market price references.
  {{< /interactive-modules/resource-card >}}
{{< /interactive-modules/resource-links >}}

{{< content-modules/section-header title="Conclusion: Investing in Vintage PING Putters" level="2" >}}
