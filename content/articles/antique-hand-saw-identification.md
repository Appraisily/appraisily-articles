---
title: >-
  Antique Hand Saw Identification: A Comprehensive Guide to Dating and Valuing
  Vintage Saws
description: >-
  Learn how to identify, date, and value antique hand saws using detailed
  characteristics of handles, medallions, blades, and manufacturer markings from
  major brands like Disston, HSB & Co, and more.
slug: antique-hand-saw-identification
date: 2023-11-01T14:30:00.000Z
lastmod: 2023-11-01T14:30:00.000Z
draft: false
featured_image: >-
...
image_alt: >-
  Vintage hand saws displaying various manufacturer medallions, handle designs,
  and blade types for identification
category: Tools
type: article
author: Appraisily Team
featured: true
meta_title: 'Antique Hand Saw Identification Guide: Dating & Valuing Old Saws'
meta_description: >-
  Learn to identify antique hand saws by examining medallions, handles, and
  manufacturer markings from Disston, HSB & Co and others to determine age and
  value.
canonical_url: 'https://articles.appraisily.com/articles/antique-hand-saw-identification'
keywords:
...
structured_data:
  ...
  mainEntityOfPage:
    '@type': WebPage
    '@id': 'https://articles.appraisily.com/articles/antique-hand-saw-identification'
  headline: >-
    Antique Hand Saw Identification: A Comprehensive Guide to Dating and Valuing
    Vintage Saws
  description: >-
...
{{< content-modules/section-header title="Why Identify Antique Hand Saws?" level="2" >}}
Understanding the age, manufacturer, and type of an antique hand saw not only satisfies historical curiosity but also helps determine its value and potential use in woodworking projects. Proper identification reveals the craftsmanship, technological innovations, and industrial design elements of different eras.
...
<div class="stat-card">
  ...
  <div class="stat-description">Most sought-after antique saws date from this period, with pre-1940 models commanding the highest prices</div>
</div>

<div class="stat-card">
  <div class="stat-value" style="color: var(--color-success);">$30-$800+</div>
  <div class="stat-label">Value Range</div>
  <div class="stat-description">Market value for antique hand saws based on rarity, condition, manufacturer, and historical significance</div>
</div>

<div class="stat-card">
  <div class="stat-value" style="color: var(--color-warning);">300%</div>
  <div class="stat-label">Restoration Impact</div>
  <div class="stat-description">Proper restoration and preservation can increase the value of high-quality antique saws by up to 300%</div>
</div>

{{< content-modules/section-header title="Key Manufacturers of Antique Hand Saws" level="2" >}}
Knowing the major manufacturers helps narrow down when and where your saw was made. Each company had distinctive features, quality standards, and production periods that aid in identification.
{{< /content-modules/section-header >}}
...
![Various types of antique hand saws including panel saws, back saws, and rip saws arranged to show design differences](https://ik.imagekit.io/appraisily/SEO/antique-hand-saw-identification/antique-hand-saw-identification-image-3_b8H7f8PLv.png)

{{< content-modules/section-header title="Identifying by Medallion and Handle Features" level="2" >}}
The medallion (the embossed metal plate on the handle) and the handle design are two of the most reliable ways to identify and date antique hand saws.
{{< /content-modules/section-header >}}

### Medallion Timeline Analysis
Medallions underwent distinct design changes that help establish manufacturing dates:

{{< visual-modules/timeline title="Disston Medallion Evolution" >}}
  {{< visual-modules/timeline-item date="1840-1846" title="H. Disston Medallion" >}}
    Early oval medallions marked "H. DISSTON" (no "& SON" or "& SONS")
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1846-1865" title="H. Disston & Son" >}}
    Addition of "& SON" (singular) after Hamilton Disston joined the firm
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1865-1871" title="H. Disston & Sons" >}}
    Changed to "& SONS" (plural) as more family members joined
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1871-1890" title="Keystone Trademark Added" >}}
    Introduction of the Keystone symbol representing Pennsylvania
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1890-1917" title="Henry Disston & Sons" >}}
    Full "HENRY DISSTON & SONS" name used
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1917-1955" title="Henry Disston & Sons, Inc." >}}
    Addition of "INC." after incorporation of the company
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="Post-1928" title="D-Series Designation" >}}
...
{{< visual-modules/hero-image src="https://ik.imagekit.io/appraisily/SEO/antique-hand-saw-identification/antique-hand-saw-identification-image-4_iw2s_gRwl.png" alt="Close-up details of an antique Disston hand saw showing blade etching, handle craftsmanship, and medallion" caption="Distinctive features of a circa 1890s Disston No. 7 hand saw showing the characteristic medallion, apple wood handle, and blade etching" />}}

{{< content-modules/section-header title="Blade Characteristics and Markings" level="2" >}}
The saw blade itself contains numerous identification clues in its etch patterns, shape, and tooth configuration that can help determine both the manufacturer and the intended use of the saw.
{{< /content-modules/section-header >}}
...
{{< data-modules/price-table title="Antique Hand Saw Value Ranges" description="Current market values based on condition, rarity, and manufacturer" >}}
  <tr>
    <td>Disston No. 7 or No. 8 (Pre-1900)</td>
    <td>$100-$350</td>
    <td>Premium models with apple/rosewood handles</td>
  </tr>
  <tr>
    <td>Disston No. 12 or No. 16</td>
    <td>$150-$450</td>
    <td>Rare premium models in excellent condition</td>
  </tr>
  <tr>
    <td>Split-nut era saws (Pre-1870s)</td>
    <td>$200-$800+</td>
    <td>Especially early models with clear etchings</td>
  </tr>
  <tr>
    <td>Warranted Superior saws</td>
    <td>$40-$150</td>
    <td>Depending on condition and handle quality</td>
  </tr>
  <tr>
    <td>Common Disston D-8 (Post-1928)</td>
    <td>$30-$100</td>
    <td>Most common antique saw model</td>
  </tr>
  <tr>
    <td>Rare manufacturer models</td>
    <td>$200-$600</td>
    <td>Unusual models from Atkins, Simonds, etc.</td>
  </tr>
{{< /data-modules/price-table >}}

{{< content-modules/section-header title="Common Antique Hand Saw Models & Identifying Features" level="2" >}}
Certain models stand out in the antique saw world for their prevalence, quality, or distinctive characteristics. Knowing these can help quickly identify what you have.
{{< /content-modules/section-header >}}
...
![Antique hand saw restoration process showing before and after cleaning of an early Disston hand saw](https://ik.imagekit.io/appraisily/SEO/antique-hand-saw-identification/antique-hand-saw-identification-image-5_YJaGwwhEj.png)

{{< content-modules/section-header title="Condition Assessment for Valuation" level="2" >}}
Condition dramatically affects the value of antique hand saws, with original features and minimal wear commanding premium prices. Here's how to evaluate the condition of a vintage saw.
{{< /content-modules/section-header >}}
...
{{< content-modules/section-header title="Dating Your Antique Hand Saw" level="2" >}}
Precise dating often requires examining multiple features together. Here's a systematic approach to narrowing down the age of your saw.
{{< /content-modules/section-header >}}
...
{{< content-modules/faq title="Common Questions About Antique Hand Saw Identification" id="faq-section" >}}
  {{< content-modules/faq-item question="What are the names of old hand saws?" >}}
  ...
  {{< content-modules/faq-item question="How can I tell how old a hand saw is?" >}}
  ...
  {{< content-modules/faq-item question="How to identify antique crosscut saws?" >}}
  ...
  {{< content-modules/faq-item question="What are the three types of hand saw?" >}}
  ...
  {{< content-modules/faq-item question="What is the oldest hand saw?" >}}
...
{{< content-modules/section-header title="Collecting and Preserving Antique Hand Saws" level="2" >}}
Whether you're building a collection or preserving family heirlooms, proper care ensures these tools remain intact for future generations.
{{< /content-modules/section-header >}}
...
{{< interactive-modules/resource-links title="External Resources for Antique Saw Identification" columns="2" >}}
  {{< interactive-modules/resource-card title="Disstonian Institute Quick Glance Guide" url="https://www.disstonianinstitute.com/quickglance.html" type="guide" >}}
    Comprehensive reference for identifying Disston handsaw models, featuring detailed information on handle styles, model numbers, and production periods from 1845-1990s.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Medallion Timeline & Dating Guide" url="https://www.disstonianinstitute.com/medv2.html" type="tool" >}}
    Detailed chronology of Disston medallion designs with clear images and date ranges to help precisely date your antique saw based on medallion characteristics.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Buyer's Guide to Antique Handsaws" url="https://www.finewoodworking.com/project-guides/hand-tools/buyers-guide-antique-handsaws" type="article" >}}
    Expert guidance from antique tool dealer Josh Clark on what to look for when evaluating and purchasing vintage handsaws, including condition assessment.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Vintage Saws Medallion Study" url="http://www.vintagesaws.com/library/ftj/medallion/medallionstudy.html" type="research" >}}
    In-depth analysis of saw medallions with detailed photographs comparing different styles and manufacturers to help with identification and dating.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Sawmill Creek Forum - Hand Saw Identification" url="https://sawmillcreek.org/showthread.php?134492-How-can-I-tell-how-old-a-hand-saw-is" type="forum" >}}
    Active woodworking community with extensive discussions on dating and identifying antique hand saws, featuring expert contributor insights and identification help.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="LumberJocks Vintage Hand Saw Threads" url="https://www.lumberjocks.com/threads/hand-saw-identification.355901/" type="forum" >}}
    Collector and user forum with numerous threads dedicated to hand saw identification, restoration techniques, and valuation discussions.
  {{< /interactive-modules/resource-card >}}
{{< /interactive-modules/resource-links >}}

{{< content-modules/section-header title="Conclusion: The Rewarding World of Antique Hand Saws" level="2" >}}
Identifying antique hand saws connects us with the rich history of craftsmanship and industrial development. Whether you're a collector, woodworker, or history enthusiast, understanding these tools provides insight into how generations before us shaped their world.
{{< /content-modules/section-header >}}
