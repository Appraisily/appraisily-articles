---
title: >-
  Decoding Antique Glass Bottle Markings: A Guide to Bottom Embossing
  Identification
description: >-
  Learn how to identify and value antique glass bottles through bottom markings
  and embossing. Discover dates, makers, and value indicators with our
  comprehensive guide.
slug: antique-identification-glass-bottle-markings-bottom
...
image_alt: >-
  Collection of antique glass bottles showing distinctive manufacturer markings
  and embossing on their bases
category: Glass Collectibles
type: article
author: Appraisily Team
featured: true
meta_title: 'Antique Glass Bottle Markings: Identify Value Through Bottom Codes'
meta_description: >-
  Discover how to decode antique glass bottle bottom markings to determine age,
  manufacturer, and value. Our expert guide reveals the secrets behind embossed
  symbols and numbers.
canonical_url: >-
...
![Various antique glass bottles displaying manufacturer markings on their bottoms](https://ik.imagekit.io/appraisily/SEO/antique-identification-glass-bottle-markings-bottom/antique-identification-glass-bottle-markings-bottom-image-1_h2BBOA3KY.png)

{{< content-modules/section-header title="The Language of Glass: Why Bottom Markings Matter" level="2" >}}
  These distinctive marks on the bottoms of glass bottles are far more than manufacturing curiosities—they are crucial clues for collectors, archaeologists, and historians alike. Understanding these markings can unlock a bottle's history and value.
...
{{< data-modules/stats-highlight title="Antique Bottle Collecting Facts" columns="3" / />}}
  <div class="stat-card green">
    ...
    <div class="stat-description">The earliest identifiable maker's marks on glass bottles date back to the 17th century</div>
  </div>
  
  <div class="stat-card blue">
    <div class="stat-value">1860</div>
    <div class="stat-label">Pontil Mark Transition</div>
    <div class="stat-description">Most bottles made after 1860 lack pontil marks, a key dating characteristic</div>
  </div>
  
  <div class="stat-card orange">
    <div class="stat-value">400%</div>
    <div class="stat-label">Value Increase</div>
    <div class="stat-description">Properly identified rare bottles can be worth up to 400% more than unidentified similar bottles</div>
  </div>

{{< content-modules/section-header title="Types of Bottle Base Markings and What They Mean" level="2" >}}
  Glass bottle bases contain various types of markings that serve different purposes. Learning to distinguish between these markings is the first step in accurate bottle identification.
{{< /content-modules/section-header >}}
...
![Closeup of manufacturer's marks on antique glass bottle bases](https://ik.imagekit.io/appraisily/SEO/antique-identification-glass-bottle-markings-bottom/antique-identification-glass-bottle-markings-bottom-image-2_EoTVdObE_.png)

For example, if you find a bottle with "SF & PGW" embossed on the bottom, as noted by [Antique Trader](https://www.antiquetrader.com/collectibles/bottle-trademark-identification), you've identified a bottle made by the Pacific Glass Works in San Francisco, potentially dating to the mid-19th century.

### Mold Numbers

Single or double-digit numbers found on bottle bases typically indicate mold numbers used in production. According to [Glass Bottle Marks](https://glassbottlemarks.com/numbers-on-bottoms-of-glass-bottles/), these numbers helped factories track which molds might be producing defective bottles or needed replacement.
...
According to [True Legacy Homes](https://www.truelegacyhomes.com/age-glass-bottles/), date codes became more common after the 1930s when automated bottle manufacturing became standard.
...
According to the [Society for Historical Archaeology](https://sha.org/bottle/bases.htm), bottles with pontil marks generally date to before 1860, with most commercial bottles after this period lacking such marks. The presence of a pontil mark can significantly increase a bottle's value among serious collectors.

{{< visual-modules/timeline title="Evolution of Glass Bottle Manufacturing" >}}
  {{< visual-modules/timeline-item date="Pre-1800s" title="Hand-Blown Era" >}}
    Bottles made entirely by hand, featuring distinct pontil marks on their bases, irregular shapes, and often asymmetrical forms.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1800-1880" title="Transitional Period" >}}
    Introduction of molds for bottle bodies, but still finished by hand. Pontil marks begin to disappear toward the end of this period.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1880-1910" title="Semi-Automatic Period" >}}
    Semi-automatic bottle machines introduced, creating more uniform bottles. Manufacturer marks become more common.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1910-Present" title="Fully Automatic Era" >}}
...
{{< content-modules/section-header title="How to Identify Specific Bottle Manufacturer Marks" level="2" >}}
  Recognizing specific manufacturer marks is crucial for accurate bottle identification. This knowledge can help pinpoint production dates and origins with remarkable precision.
{{< /content-modules/section-header >}}

The most reliable way to identify manufacturer marks is to consult specialized resources. The [Society for Historical Archaeology's Bottle Website](https://sha.org/bottle/makersmarks.htm) maintains a comprehensive database of maker's marks organized alphabetically and by country of origin.
...
![Collection of antique bottles showing different manufacturer marks](https://ik.imagekit.io/appraisily/SEO/antique-identification-glass-bottle-markings-bottom/antique-identification-glass-bottle-markings-bottom-image-3_XlnMt1ByK.png)
...
While American bottle marks are well-documented, bottles from European, Asian, and other origins have their own distinctive marking systems. Resources like [Glass Bottle Marks](https://glassbottlemarks.com/bottlemarks/) offer information on international manufacturer marks as well.

{{< data-modules/price-table title="Antique Bottle Value Ranges Based on Markings" description="Market values vary based on manufacturer, condition, and rarity" >}}
  <tr>
    <td>Unmarked pre-1900 bottles</td>
    <td>$10-$75</td>
    <td>Varies by color, condition, and style</td>
  </tr>
  <tr>
    <td>Common maker's marks (Ball, Owens-Illinois)</td>
    <td>$15-$150</td>
    <td>Higher values for unusual colors or styles</td>
  </tr>
  <tr>
    <td>Rare manufacturer marks (early American)</td>
    <td>$100-$500+</td>
    <td>Particularly early colored glass examples</td>
  </tr>
  <tr>
    <td>Pontil-marked bottles (pre-1860)</td>
    <td>$75-$1,000+</td>
    <td>Especially valuable in colors other than aqua/clear</td>
  </tr>
  <tr>
    <td>Historic bottles with documented provenance</td>
    <td>$500-$5,000+</td>
    <td>Museum-quality pieces with authenticated history</td>
  </tr>
{{< /data-modules/price-table >}}

{{< content-modules/section-header title="Decoding Numbers and Symbols on Bottle Bases" level="2" >}}
  Numbers and symbols that aren't clearly manufacturer marks serve various purposes and require careful interpretation to properly identify their meaning.
{{< /content-modules/section-header >}}

### Understanding Mold Numbers

As discussed on [Glass Bottle Marks](https://glassbottlemarks.com/numbers-on-bottoms-of-glass-bottles/), single or double-digit numbers on bottle bases typically indicate the specific mold that was used to form the bottle. For example:
...
Many 20th-century liquor bottles carry specific code patterns on their bases. According to bottle forums like [Historic Glasshouse](https://forum.antiquebottles-glass.com/d/2314-bottom-of-the-bottle-identification), these can indicate:
...
{{< content-modules/section-header title="Dating Bottles Using Base Markings" level="2" >}}
  Bottom markings are invaluable for determining a bottle's age, often allowing for remarkably precise dating when properly interpreted.
{{< /content-modules/section-header >}}

### Pontil Marks and Age

According to the [Society for Historical Archaeology](https://sha.org/bottle/bases.htm), pontil marks are one of the clearest indicators of age for very old bottles:
...
![Close-up of date codes on vintage glass bottle bases](https://ik.imagekit.io/appraisily/SEO/antique-identification-glass-bottle-markings-bottom/antique-identification-glass-bottle-markings-bottom-image-5_cKLYslAsg.png)
...
{{< content-modules/section-header title="How Base Markings Affect Bottle Value" level="2" >}}
  The markings on a bottle's base can dramatically impact its value to collectors, sometimes turning an ordinary bottle into a prized collectible.
{{< /content-modules/section-header >}}
...
{{< data-modules/stats-highlight title="Bottle Collecting Market Insights" columns="3" / />}}
  <div class="stat-card blue">
    ...
    <div class="stat-description">Up to 75% of an antique bottle's value can be tied to proper identification of its maker and age</div>
  </div>
  
  <div class="stat-card green">
    <div class="stat-value">30%</div>
    <div class="stat-label">Premium for Documentation</div>
    <div class="stat-description">Bottles with documented provenance typically sell for 20-30% more than identical undocumented examples</div>
  </div>
  
  <div class="stat-card orange">
    <div class="stat-value">$5,000+</div>
    <div class="stat-label">Potential Value</div>
    <div class="stat-description">Rare pre-1860 pontil-marked bottles in unusual colors can exceed $5,000 at specialized auctions</div>
  </div>

{{< content-modules/section-header title="Research Tools and Resources for Bottle Base Identification" level="2" >}}
  Accurate bottle identification often requires specialized references and tools beyond general antique guides.
{{< /content-modules/section-header >}}
...
- [The Society for Historical Archaeology's Bottle Website](https://sha.org/bottle/) provides extensive information on bottle dating, typology, and maker's marks
- [Glass Bottle Marks](https://glassbottlemarks.com/) offers an alphabetized catalog of glass manufacturers and their distinctive marks
- [Historic Glasshouse Forum](https://forum.antiquebottles-glass.com/) connects collectors who can help identify unusual or rare markings
...
{{< interactive-modules/resource-links title="Essential Bottle Identification Resources" columns="2" >}}
  {{< interactive-modules/resource-card title="Society for Historical Archaeology Bottle Website" url="https://sha.org/bottle/" type="tool" >}}
  ...
  {{< interactive-modules/resource-card title="Antique Trader: Bottle Trademark Identification" url="https://www.antiquetrader.com/collectibles/bottle-trademark-identification" type="article" >}}
    Expert guidance on understanding and identifying various trademark styles found on antique bottle bases.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Historic Glasshouse Forum" url="https://forum.antiquebottles-glass.com/" type="community" >}}
    Active community of bottle collectors who can help identify unusual or difficult-to-research bottle markings.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="True Legacy Homes: Dating Glass Bottles" url="https://www.truelegacyhomes.com/age-glass-bottles/" type="guide" >}}
    Comprehensive guide to determining bottle age through various physical characteristics including base markings.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Numbers on Bottoms of Glass Bottles" url="https://glassbottlemarks.com/numbers-on-bottoms-of-glass-bottles/" type="reference" >}}
...
{{< content-modules/section-header title="Common Challenges in Bottle Base Identification" level="2" >}}
  Even experienced collectors face certain challenges when trying to identify bottle bases. Understanding these common issues can help avoid misidentification.
{{< /content-modules/section-header >}}
...
As discussed on forums like [Reddit's Whatisthis community](https://www.reddit.com/r/Whatisthis/comments/10bbqy7/century_old_glass_bottle_i_found_at_work/), one of the most common mistakes is misinterpreting numbers on bottle bases:
...
{{< content-modules/faq title="Common Questions About Bottle Base Markings" id="bottle-marking-faqs" >}}
  {{< content-modules/faq-item question="How do you identify old bottles by numbers on the bottom?" >}}
  ...
  {{< content-modules/faq-item question="What are the codes on the bottom of bottles?" >}}
  ...
  {{< content-modules/faq-item question="What are the symbols on the bottom of glass bottles?" >}}
  ...
  {{< content-modules/faq-item question="How can I tell if a glass bottle is valuable based on its bottom markings?" >}}
    While markings are important value indicators, they must be considered alongside other factors:
    
    1. **Age indicators**: Pontil marks typically indicate pre-1860 production, often increasing value
    2. **Rarity of manufacturer**: Marks from short-lived or regional glassworks can be more valuable
    3. **Production method**: Evidence of hand-finishing generally adds value
    4. **Historical significance**: Bottles tied to significant events or locations through their markings
    5. **Condition of the marking**: Clear, well-preserved marks are more desirable than worn examples
  ...
  {{< content-modules/faq-item question="Can bottom markings help determine if my bottle is a reproduction?" >}}
  ...
  {{< content-modules/faq-item question="What's the difference between a date code and a mold number on a bottle base?" >}}
  ...
  {{< content-modules/faq-item question="How can I identify a bottle with no visible maker's mark on the bottom?" >}}
    When no clear manufacturer's mark is present, consider these alternative identification approaches:
    
    1. **Examine the entire bottle**: Sometimes marks appear on shoulders, heels, or sides
    2. **Consider glass color**: Certain colors were produced primarily in specific time periods
    3. **Study production techniques**: Seam patterns and finish types indicate manufacturing methods
    4. **Research bottle shape and design**: Many forms were specific to particular products or regions
    5. **Consider contents indicators**: Embossing may reveal original contents, narrowing down producers
  ...
  {{< content-modules/faq-item question="Are there apps or tools that can help identify bottle base markings?" >}}
...
{{< content-modules/section-header title="Conclusion: The Value of Understanding Bottle Base Markings" level="2" >}}
  Mastering the interpretation of bottle base markings opens a window into history while potentially uncovering hidden value in everyday objects.
{{< /content-modules/section-header >}}
