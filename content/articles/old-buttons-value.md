---
title: 'Old Buttons Value: Collector''s Guide to Identifying Rare & Valuable Finds'
description: >-
  Discover how to identify and value old buttons in our comprehensive guide.
  Learn about valuable vintage buttons, their history, and what makes certain
  buttons collector's treasures.
slug: old-buttons-value
...
featured: true
meta_title: 'Old Buttons Value: Identify & Price Antique Button Treasures'
meta_description: >-
  Discover what makes old buttons valuable, from rare materials to historical
  significance. Learn how to identify potential treasures worth $50 to thousands
  in your collection.
canonical_url: 'https://articles.appraisily.com/articles/old-buttons-value'
keywords:
  - old buttons value
...
structured_data:
  ...
  '@type': Article
  headline: 'Old Buttons Value: Collector''s Guide to Identifying Rare & Valuable Finds'
  description: >-
    Comprehensive guide to determining the value of antique buttons, from common
    specimens worth under $50 to rare examples fetching thousands at auction.
    Learn about materials, craftsmanship, and historical significance.
  author:
    '@type': Organization
...
Throughout history, buttons have served both functional and decorative purposes, transforming from mere fasteners to valuable collectibles that capture moments in design, fashion, and technological innovation. Today, antique buttons can be cherished treasures with significant monetary and historical value.
{{< /content-modules/section-header >}}

![Collection of valuable antique buttons in various materials and designs](https://ik.imagekit.io/appraisily/SEO/old-buttons-value/old-buttons-value-image-1_UM3BAzLC5.png)
...
<div class="stat-card blue">
  ...
  <div class="stat-description">Victorian era produced some of the most valuable buttons</div>
</div>

<div class="stat-card green">
  <div class="stat-value">$3,900+</div>
  <div class="stat-label">High Value</div>
  <div class="stat-description">Some rare antique buttons can sell for thousands</div>
</div>

<div class="stat-card orange">
  <div class="stat-value">30%</div>
  <div class="stat-label">Value Premium</div>
  <div class="stat-description">Average added value for buttons with original cards</div>
</div>

{{< content-modules/section-header title="Types of Antique Buttons by Material" level="2" >}}
One of the primary factors determining an old button's value is the material from which it was made. Each material carries its own historical significance and different manufacturing challenges, affecting rarity and collectibility.
{{< /content-modules/section-header >}}

![Assortment of antique buttons made from different materials including metal, pearl, and porcelain](https://ik.imagekit.io/appraisily/SEO/old-buttons-value/old-buttons-value-image-2_p3CjQUqfi.png)
...
{{< data-modules/price-table title="Value Ranges by Button Material" description="Average market prices for antique buttons in good condition" >}}
<tr>
  <td>Metal (Military or Historic)</td>
  <td>$20 - $300+</td>
  <td>Higher value for documented provenance</td>
</tr>
<tr>
  <td>Mother of Pearl/Shell (Carved)</td>
  <td>$15 - $100</td>
  <td>Intricate designs command premium prices</td>
</tr>
<tr>
  <td>Porcelain (Hand-painted)</td>
  <td>$25 - $150</td>
  <td>Japanese Satsuma or French Limoges highest valued</td>
</tr>
<tr>
  <td>Glass (Paperweight/Millefiori)</td>
  <td>$20 - $75</td>
  <td>Bohemian examples particularly desirable</td>
</tr>
<tr>
  <td>Ivory or Tagua Nut</td>
  <td>$20 - $150</td>
  <td>Legal antique ivory requires documentation</td>
</tr>
<tr>
  <td>Celluloid/Early Plastic</td>
  <td>$10 - $50</td>
  <td>Realistic imitations most valuable</td>
</tr>
<tr>
  <td>Picture or Story Buttons</td>
  <td>$15 - $200</td>
  <td>Complete sets can fetch much higher prices</td>
</tr>
{{< /data-modules/price-table >}}

{{< content-modules/section-header title="Factors That Determine Button Value" level="2" >}}
Beyond material, several key factors affect the value of antique buttons. Understanding these elements will help you identify potentially valuable specimens in any collection.
{{< /content-modules/section-header >}}

![Close-up of rare antique buttons with intricate detailing and unique designs](https://ik.imagekit.io/appraisily/SEO/old-buttons-value/old-buttons-value-image-3__YGEpfyF_.png)
...
While most old buttons have modest values, certain types consistently command premium prices. Understanding these categories can help you identify potential treasures.
{{< /content-modules/section-header >}}
...
![Collection of antique military and uniform buttons with various insignias and designs](https://ik.imagekit.io/appraisily/SEO/old-buttons-value/old-buttons-value-image-4_phh6AJqgXC.png)
...
{{< visual-modules/timeline title="Historical Timeline of Button Development" >}}
  {{< visual-modules/timeline-item date="1700s" title="Early Precious Metal Buttons" >}}
  ...
  {{< visual-modules/timeline-item date="1800-1850" title="Rise of Decorative Buttons" >}}
  ...
  {{< visual-modules/timeline-item date="1850-1900" title="Victorian Button Golden Age" >}}
  ...
  {{< visual-modules/timeline-item date="1900-1930" title="Transition to Modern Materials" >}}
    Introduction of celluloid and early plastics. Art Nouveau and later Art Deco influences appear in button design.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1930-1960" title="Bakelite and Synthetic Materials" >}}
...
{{< content-modules/section-header title="How to Identify Valuable Buttons in Your Collection" level="2" >}}
With the vast variety of button types and designs, identifying potentially valuable specimens requires careful examination and research.
{{< /content-modules/section-header >}}

![Person examining antique buttons with magnifying glass to identify valuable specimens](https://ik.imagekit.io/appraisily/SEO/old-buttons-value/old-buttons-value-image-5_X1vBg3Vmg-.png)
...
{{< interactive-modules/resource-links title="Button Identification Resources" columns="2" >}}
  ...
  {{< interactive-modules/resource-card title="Button Country Reference Guide" url="https://www.buttoncountry.com/button-reference-guide" type="guide" >}}
  ...
  {{< interactive-modules/resource-card title="WorthPoint Button Dictionary" url="https://www.worthpoint.com/dictionary/p/textiles-clothing-accessories/textiles-accessories/buttons" type="database" >}}
    Resource for button values, marks, and historical information with price guide access.
  {{< /interactive-modules/resource-card >}}
{{< /interactive-modules/resource-links >}}

{{< content-modules/section-header title="Where to Sell Valuable Antique Buttons" level="2" >}}
If you've discovered valuable buttons in your collection and wish to sell them, several options exist depending on the buttons' rarity and value.
{{< /content-modules/section-header >}}
...
{{< auction-results title="Notable Button Auction Results" description="Recent sales of exceptional antique buttons" >}}
  <tr>
    <td>Collection of 19th-century French picture buttons</td>
    <td>$2,800</td>
    <td>March 2023</td>
    <td>Heritage Auctions</td>
  </tr>
  <tr>
    <td>Set of six enamel and gold Victorian buttons</td>
    <td>$3,900</td>
    <td>November 2022</td>
    <td>Sotheby's</td>
  </tr>
  <tr>
    <td>Civil War Union Army officer's gilt buttons (12)</td>
    <td>$1,200</td>
    <td>January 2023</td>
    <td>Cowan's Auctions</td>
  </tr>
  <tr>
    <td>Collection of 200+ Victorian black glass buttons</td>
    <td>$1,750</td>
    <td>April 2023</td>
    <td>eBay</td>
  </tr>
  <tr>
    <td>Rare 18th-century silver and paste jewel buttons (4)</td>
    <td>$4,200</td>
    <td>December 2022</td>
    <td>Christie's</td>
  </tr>
...
{{< content-modules/section-header title="Button Collecting as a Hobby" level="2" >}}
Whether you're interested in buttons for their potential value or simply appreciate their artistic and historical significance, button collecting can be a rewarding hobby.
{{< /content-modules/section-header >}}
...
{{< content-modules/faq title="Common Questions About Old Button Values" id="faq-section" >}}
  {{< content-modules/faq-item question="Do old buttons have any value?" >}}
  ...
  {{< content-modules/faq-item question="How can I identify the age of an old button?" >}}
  ...
  {{< content-modules/faq-item question="What types of old buttons are the most valuable?" >}}
  ...
  {{< content-modules/faq-item question="Where can I sell valuable old buttons?" >}}
  ...
  {{< content-modules/faq-item question="Can you donate old buttons?" >}}
  ...
  {{< content-modules/faq-item question="Are old political or campaign buttons valuable?" >}}
  ...
  {{< content-modules/faq-item question="How should I store valuable antique buttons?" >}}
  ...
  {{< content-modules/faq-item question="Is there an app for identifying vintage buttons?" >}}
...
{{< interactive-modules/resource-links title="External Resources" columns="2" >}}
  {{< interactive-modules/resource-card title="LoveToKnow: Identifying Rare & Valuable Antique Buttons" url="https://www.lovetoknow.com/home/antiques-collectibles/identifying-rare-valuable-antique-buttons" type="article" >}}
    Comprehensive guide to identifying potentially valuable antique buttons with advice on materials and collecting trends.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="HobbyLark: Vintage Button Guide" url="https://hobbylark.com/collecting/Vintage-Button-Guide-Ways-to-Indentify-Antique-Buttons" type="guide" >}}
    Detailed identification techniques for various types of antique and vintage buttons with visual examples.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="WorthPoint: Button Dictionary & Price Guide" url="https://www.worthpoint.com/dictionary/p/textiles-clothing-accessories/textiles-accessories/buttons" type="database" >}}
  ...
  {{< interactive-modules/resource-card title="Valuable Antiques: Antique Buttons Guide" url="https://valuableantiques.org/antique-buttons-types-identification-value/" type="article" >}}
    Comprehensive guide to antique button types, identification methods, and current market values.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Amazon: Antique and Collectible Buttons Reference" url="https://www.amazon.com/Antique-Collectible-Buttons-Identification-Values/dp/0891457119" type="book" >}}
