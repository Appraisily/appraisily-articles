---
title: >-
  How to Identify Old Medicine Bottles: A Collector's Guide to Antique Glass
  Pharmacy Bottles
description: >-
  Learn how to identify and value antique glass medicine bottles with our expert
  guide covering dating techniques, markings, colors, and collector tips.
slug: identification-old-glass-medicine-bottles
...
image_alt: >-
  Vintage collection of embossed glass medicine and pharmacy bottles from the
  19th and early 20th centuries
category: Glass Collectibles
type: article
author: Appraisily Team
featured: true
meta_title: 'Identifying Antique Medicine Bottles: Dating & Value Guide'
meta_description: >-
  Learn to identify antique glass medicine bottles through embossing, pontil
  marks, colors, and manufacturing techniques. Expert tips for collectors and
  appraisers.
canonical_url: >-
...
structured_data:
  ...
  headline: >-
    ...
    Pharmacy Bottles
  description: >-
    Comprehensive guide to identifying, dating and valuing antique glass
    medicine bottles, covering manufacturing techniques, embossing, colors, and
    collector tips for pharmaceutical artifacts.
  author:
    '@type': Organization
...
{{< content-modules/section-header title="The History of Glass Medicine Bottles" level="2" >}}
Before diving into identification techniques, understanding the historical context of medicine bottles provides valuable perspective for collectors and researchers.
...
{{< visual-modules/timeline title="Evolution of Medicine Bottle Manufacturing" >}}
  {{< visual-modules/timeline-item date="Pre-1860s" title="Free-Blown Era" >}}
  ...
  {{< visual-modules/timeline-item date="1860s-1880s" title="Applied Lip Era" >}}
  ...
  {{< visual-modules/timeline-item date="1880s-1910s" title="Tooled Lip Era" >}}
    The entire bottle was blown in a mold, then the lip was shaped using specialized tools while the glass was still hot.
  {{< /visual-modules/timeline-item >}}
  
  {{< visual-modules/timeline-item date="1910s-1950s" title="Machine-Made Era" >}}
...
Learning to recognize the distinctive characteristics of old medicine bottles is essential for accurate identification and dating.
{{< /content-modules/section-header >}}
...
{{< data-modules/price-table title="Glass Colors and Their Common Time Periods" description="Major glass colors used for medicine bottles" >}}
  <tr>
    <td>Aqua/Clear Aqua</td>
    <td>1800s-1920s</td>
    <td>The most common color for 19th century medicine bottles, created by natural iron impurities in the glass</td>
  </tr>
  <tr>
    <td>Cobalt Blue</td>
    <td>1890s-1960s</td>
    <td>Popular for poison, cosmetic vessels, and specialty medicines</td>
  </tr>
  <tr>
    <td>Amber/Brown</td>
    <td>1860s-present</td>
    <td>Used for light-sensitive preparations, became increasingly common after 1910</td>
  </tr>
  <tr>
    <td>Green (various shades)</td>
    <td>1800s-1920s</td>
    <td>Common in early medicines, particularly olive green in the earliest examples</td>
  </tr>
  <tr>
    <td>Colorless (clear)</td>
    <td>1875-present</td>
    <td>Became widespread after the development of manganese decolorization processes</td>
  </tr>
  <tr>
    <td>Purple/Amethyst</td>
    <td>1880s-1920</td>
    <td>Manganese-decolorized glass that turned purple with sun exposure; production virtually ceased during WWI</td>
  </tr>
{{< /data-modules/price-table >}}

It's worth noting that clear glass that has turned purple or amethyst due to sun exposure (known as "sun-purpled") contains manganese, which was primarily used as a decolorizing agent between 1880 and 1916. When the United States entered World War I, manganese imports from Germany were cut off, and selenium became the preferred decolorizer, resulting in glass that does not turn purple with sun exposure.
...
Maker's marks on bottle bases can be particularly valuable for dating. Resources like the Society for Historical Archaeology's [Bottle Makers Marks](https://sha.org/bottle/makersmarks.htm) page provide comprehensive listings of these identifying symbols.

{{< content-modules/section-header title="Dating Techniques" level="2" >}}
Determining the approximate age of a medicine bottle involves analyzing multiple characteristics together.
{{< /content-modules/section-header >}}
...
Various factors influence the collectability and value of old medicine bottles in today's market.
{{< /content-modules/section-header >}}
...
{{< data-modules/price-table title="Value Ranges for Antique Medicine Bottles" description="Approximate market values as of 2023" >}}
  <tr>
    <td>Common machine-made pharmacy bottles (1920s-1950s)</td>
    <td>$5-$25</td>
    <td>Clear or amber glass, minimal embossing</td>
  </tr>
  <tr>
    <td>Embossed local pharmacy bottles (1880s-1910s)</td>
    <td>$20-$100</td>
    <td>Value increases with age and pharmacy significance</td>
  </tr>
  <tr>
    <td>Labeled patent medicine bottles (1880s-1920s)</td>
    <td>$30-$150</td>
    <td>Original paper labels intact</td>
  </tr>
  <tr>
    <td>Colored glass prescription bottles (1870s-1900s)</td>
    <td>$50-$200</td>
    <td>Cobalt blue, emerald green, amber</td>
  </tr>
  <tr>
    <td>Early pontiled medicine bottles (pre-1860s)</td>
    <td>$100-$500+</td>
    <td>Crude manufacturing, applied lips</td>
  </tr>
  <tr>
    <td>Rare poison bottles with unusual shapes</td>
    <td>$150-$800</td>
    <td>Skull-shaped, coffin-shaped, or hobnail patterns</td>
  </tr>
  <tr>
    <td>Figural medicine bottles (rare shapes)</td>
    <td>$200-$1,000+</td>
    <td>Bottles shaped like organs, figures, or objects</td>
  </tr>
  <tr>
    <td>Pre-Civil War medicine bottles with labels</td>
    <td>$500-$5,000+</td>
    <td>Original contents and packaging dramatically increase value</td>
  </tr>
{{< /data-modules/price-table >}}

{{< content-modules/section-header title="Collecting Strategies and Tips" level="2" >}}
Advice for both novice and experienced collectors of antique medicine bottles.
{{< /content-modules/section-header >}}
...
{{< content-modules/faq title="Common Questions About Old Medicine Bottles" id="faq-section" >}}
  {{< content-modules/faq-item question="How can you tell how old a glass medicine bottle is?" >}}
  ...
  {{< content-modules/faq-item question="Is there a free app for glass bottle identification?" >}}
    ...
    - The Society for Historical Archaeology's [Bottle Website](https://sha.org/bottle/)
  ...
  {{< content-modules/faq-item question="What do the numbers on the bottom of old bottles mean?" >}}
    ...
    4. **Patent numbers**: References to patented designs or manufacturing processes
    5. **Volume markings**: Capacity indicators (especially on later bottles)
    
    The Society for Historical Archaeology provides an extensive database of [maker's marks](https://sha.org/bottle/makersmarks.htm) to help decipher these codes.
  ...
  {{< content-modules/faq-item question="What is the most valuable antique medicine bottle?" >}}
...
Proper care and display techniques are essential for maintaining the condition and value of antique medicine bottles.
{{< /content-modules/section-header >}}
...
{{< interactive-modules/resource-links title="External Resources for Medicine Bottle Collectors" columns="2" >}}
  {{< interactive-modules/resource-card title="Society for Historical Archaeology Bottle Website" url="https://sha.org/bottle/" type="guide" >}}
    The most comprehensive online resource for bottle identification, featuring detailed information on dating techniques, maker's marks, and bottle typology.
  ...
  {{< interactive-modules/resource-card title="Federation of Historical Bottle Collectors" url="https://www.fohbc.org/" type="organization" >}}
    National organization dedicated to the study and collection of historic bottles, providing events, publications, and networking opportunities.
  {{< /interactive-modules/resource-card >}}
  ...
  {{< interactive-modules/resource-card title="Medicinal Bottles Identification Guide" url="https://sha.org/bottle/medicinal.htm" type="guide" >}}
    Specialized guide focusing specifically on medicinal bottle identification, with extensive examples and dating information.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Antique Bottle Collector's Virtual Museum" url="https://www.antiquebottles.com/virtual/" type="tool" >}}
    Visual reference library featuring thousands of categorized bottle photographs submitted by collectors worldwide.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Historic Glass Bottle Identification & Information Website" url="https://www.antiquebottle.com/" type="guide" >}}
    Extensive resource covering bottle identification, pricing guides, and collector forums for sharing knowledge.
  {{< /interactive-modules/resource-card >}}
  
  {{< interactive-modules/resource-card title="Bottle Makers Marks Reference" url="https://sha.org/bottle/makersmarks.htm" type="guide" >}}
    Comprehensive directory of glass manufacturer marks to help identify bottle origins and production dates.
  {{< /interactive-modules/resource-card >}}
